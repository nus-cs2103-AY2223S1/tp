...
public class Messages {
    ...
    public static final String MESSAGE_MISSING_CONTENT = "Missing content! \n%1$s";
    public static final String MESSAGE_MISSING_DATE = "Missing date! \n%1$s";
    public static final String MESSAGE_MISSING_INDEX = "Missing index! \n%1$s";
    public static final String MESSAGE_MISSING_NAME = "Missing name! \n%1$s";
    public static final String MESSAGE_MISSING_RATING = "Missing rating! \n%1$s";
}
