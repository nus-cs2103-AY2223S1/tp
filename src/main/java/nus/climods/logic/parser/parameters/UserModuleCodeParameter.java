...
public class UserModuleCodeParameter extends ModuleCodeParameter {
    private static final Function<String, Optional<ModuleCode>> CONVERSION_FUNCTION = ParserUtil::parseUserModuleCode;
    private static final String MESSAGE_PARSE_EXCEPTION = "Module code supplied not in your module list!";
