...
import nus.climods.model.module.exceptions.DuplicateModuleException;
import nus.climods.model.module.exceptions.ModuleNotFoundException;
import nus.climods.model.person.exceptions.PersonNotFoundException;
...
public class UniqueModuleList implements Iterable<Module> {
    ...
    public void setModules(nus.climods.model.module.UniqueModuleList replacement) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof nus.climods.model.module.UniqueModuleList // instanceof handles nulls
                && internalList.equals(((nus.climods.model.module.UniqueModuleList) other).internalList));
    }
