 ...
 */
public class PolicyAssignedDeleteCommandParser implements Parser<PolicyAssignedDeleteCommand> {
     ...
     */
    public PolicyAssignedDeleteCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                    PolicyAssignedDeleteCommand.MESSAGE_USAGE), pe);
        }
        return new PolicyAssignedDeleteCommand(personIndex, policyIndex);
    }
