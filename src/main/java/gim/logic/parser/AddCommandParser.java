...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_ADDRESS, PREFIX_WEIGHT, PREFIX_EMAIL)
        ...
        Exercise exercise = new Exercise(name, weight, email, address, tagList);
