...
public class AddToCommand extends Command {
    ...
    public static final String MESSAGE_NO_ATTRIBUTE_TO_ADD = "Only tag, rating, note, and link attributes should be added"
            + " and attributes to be added should not be empty!";
