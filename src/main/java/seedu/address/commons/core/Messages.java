...
public class Messages {
    ...
    public static final String MESSAGE_STUDENTS_NO_SUCH_STUDENT = "No such student(s) exist!";
    ...
    public static final String MESSAGE_INVALID_STUDENT_TO_UNHELP = "Help tag for %1$s is non-existent";
}
