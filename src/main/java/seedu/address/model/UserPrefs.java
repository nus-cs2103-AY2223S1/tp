...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    private Path studentRecordFilePath = Paths.get("data" , "addressbook.json");
    ...
    public void setStudentRecordFilePath(Path studentRecordFilePath) {
        ...
        this.studentRecordFilePath = studentRecordFilePath;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(guiSettings, studentRecordFilePath);
    }
