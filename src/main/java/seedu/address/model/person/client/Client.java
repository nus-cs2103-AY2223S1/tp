...
public class Client extends Person {
    ...
    public Client(String name){
        super(new Name(name), new Phone("000"), new Email("notSpecified@gmail.com"), new Address("notSpecified"), Set.of(new Tag("notSpecified")));
    }
    ...
    public Client(String name, String phone){
        super(new Name(name), new Phone(phone), new Email("notSpecified@gmail.com"), new Address("notSpecified"), Set.of(new Tag("notSpecified")));
    }
    ...
    public Client(String name, String phone, String email){
        super(new Name(name), new Phone(phone), new Email(email), new Address("notSpecified"), Set.of(new Tag("notSpecified")));
    }
    ...
    public Client(String name, String phone, String email, String address){
        super(new Name(name), new Phone(phone), new Email(email), new Address(address), Set.of(new Tag("notSpecified")));
    }
