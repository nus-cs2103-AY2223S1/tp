 ...
 * A person is considered unique by comparing using {@code Patient#isSamePerson(Patient)}. As such, adding and updating of
 * persons uses Patient#isSamePerson(Patient) for equality so as to ensure that the person being added or updated is
 * unique in terms of identity in the UniquePersonList. However, the removal of a person uses Patient#equals(Object) so
