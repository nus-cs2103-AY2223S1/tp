...
public class UniquePersonList implements Iterable<Person> {
    ...
    /**
     * Replaces the supplier {@code target} in the list with {@code editedPerson}.
     * {@code target} must exist in the list.
     * The person identity of {@code editedPerson} must not be the same as another existing supplier in the list.
     */
    ...
    /**
     * Returns true if {@code persons} contains only unique suppliers.
     */
