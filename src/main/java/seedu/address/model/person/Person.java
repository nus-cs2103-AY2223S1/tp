...
public class Person {
     ...
     */
    public Person(Name name, Phone phone, Email email, NumberOfGuests numberOfGuests, Address address, Set<Tag> tags) {
    ...
    public boolean equals(Object other) {
        ...
        return otherPerson.getName().equals(getName())
                ...
                && otherPerson.getNumberOfGuests().equals(getNumberOfGuests())
