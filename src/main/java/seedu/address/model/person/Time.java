 ...
 * Guarantees: immutable; is valid as declared in {@link #isValidDateTime(String,String)}
 */
public class Time {
     ...
     * The DateTime can only be in yyyy-mm-dd HH:mm format without any space at the front.
     */
    ...
    public Time(String time) {
        ...
        this.time = LocalTime.parse(time + ":00");
    }
