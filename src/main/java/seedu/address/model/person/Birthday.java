...
public class Birthday implements DeepCopyable {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Birthdays must only take in valid months and days of "
            + "the respective months in dd/MM/yyyy format";
    // solution adapted from https://stackoverflow.com/questions/15491894/regex-to-validate-date-formats-dd-mm-yyyy-dd-mm-yyyy-dd-mm-yyyy-dd-mmm-yyyy
