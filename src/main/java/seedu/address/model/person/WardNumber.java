...
public class WardNumber {
    public static final String MESSAGE_CONSTRAINTS = "Ward Number is one uppercase alphabet followed by "
            + "a 3 digit number for inpatient patients and blank for outpatient patients";
