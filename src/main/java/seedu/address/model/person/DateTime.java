...
public class DateTime implements Comparable<DateTime> {
    public static final String DEFAULT_DAY_OUT_OF_BOUNDS_ERROR_MESSAGE = "Invalid value for DayOfMonth (valid values 1 - 28/31)";
    public static final String DEFAULT_MONTH_OUT_OF_BOUNDS_ERROR_MESSAGE = "Invalid value for MonthOfYear (valid values 1 - 12)";
