 ...
 */
public class CompositePredicate implements Predicate<Commission> {
     ...
     */
    public CompositePredicate(List<String> keywords, List<Tag> intersectTags, List<Tag> unionTags) {
    ...
    public boolean equals(Object other) {
        if (other == this) {
            return true;
        } else if (other instanceof CompositePredicate) {
            CompositePredicate otherPredicate = (CompositePredicate) other;
