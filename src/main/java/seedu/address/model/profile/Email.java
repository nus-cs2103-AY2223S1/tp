...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format local-part@domain "
            ...
            + "2. Emails cannot start or end with a special character.\n"
            + "3. Emails must begin with an alphabet.\n"
            + "4. This is followed by a '@' and then a domain name. The domain name must one of the following "
            + "NUS email domains:\n"
            + "    - u.nus.edu\n"
            + "    - u.duke.nus.edu\n"
            + "    - nus.edu.sg\n"
