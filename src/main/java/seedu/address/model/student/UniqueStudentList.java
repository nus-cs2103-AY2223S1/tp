 ...
 * updating of persons uses Student#isSameStudent(Student) for equality so as to ensure that the person being added or
 * updated is unique in terms of identity in the UniqueStudentList. However, the removal of a person uses
 * Student#equals(Object) so as to ensure that the person with exactly the same fields will be removed.
 *
...
public class UniqueStudentList implements Iterable<Student> {
     ...
     * The person identity of {@code editedStudent} must not be the same as another existing student in the list.
     */
