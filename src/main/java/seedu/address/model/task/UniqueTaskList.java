 ...
 * adding and updating of tasks uses Task#isSameTask(Task) for equality to ensure that the
 * task being added or updated is unique in terms of identity in the UniqueTaskList. However,
 * the removal of a task uses Task#equals(Object) to ensure that the task with exactly the
