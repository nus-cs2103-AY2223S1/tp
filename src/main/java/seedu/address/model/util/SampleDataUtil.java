...
public class SampleDataUtil {
    public static Expenditure[] getSampleExpenditure() {
        return new Expenditure[]{
            new Expenditure(new Description("Lunch"), new Date("20-01-2022"), new Amount("20"), getTagSet("Lunch")),
            new Expenditure(new Description("Dinner"), new Date("20-02-2022"), new Amount("30"), getTagSet("Dinner")),
            new Expenditure(new Description("Breakfast"), new Date("21-01-2022"), new Amount("40"),
                getTagSet("Breakfast")),
            new Expenditure(new Description("Paid this guy"), new Date("21-01-2022"), new Amount("0.10"),
                getTagSet("paid"))
        };
    }
