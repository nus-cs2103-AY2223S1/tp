    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                ...
                new CriticalIllnessInsurance(true), new LifeInsurance(true), new Reminder("dummy reminder"),
            ...
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                ...
                new HealthInsurance(false), new DisabilityInsurance(false),
                new CriticalIllnessInsurance(false), new LifeInsurance(false), new Reminder("dummy reminder"),
