...
public class SampleDataUtil {
    public static Buyer[] getSampleBuyers() {
        return new Buyer[] {
            new Buyer(new PersonCategory("Buyer"), new Name("This Is BuyerList"), new Phone("87438807"),
                    new Email("alexyeoh@example.com"), new Address("Blk 30 Geylang Street 29, #06-40"),
                    getTagSet("friends"), new ArrayList<Order>()),
            new Buyer(new PersonCategory("Buyer"), new Name("Bernice Yu"), new Phone("99272758"),
                    new Email("berniceyu@example.com"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                    getTagSet("colleagues", "friends"), new ArrayList<Order>()),
            new Buyer(new PersonCategory("Buyer"), new Name("Charlotte Oliveiro"), new Phone("93210283"),
                    new Email("charlotte@example.com"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                    getTagSet("neighbours"), new ArrayList<Order>()),
            new Buyer(new PersonCategory("Buyer"), new Name("David Li"), new Phone("91031282"),
                    new Email("lidavid@example.com"), new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                    getTagSet("family"), new ArrayList<Order>()),
            new Buyer(new PersonCategory("Buyer"), new Name("Irfan Ibrahim"), new Phone("92492021"),
                    new Email("irfan@example.com"), new Address("Blk 47 Tampines Street 20, #17-35"),
                    getTagSet("classmates"), new ArrayList<Order>()),
            new Buyer(new PersonCategory("Buyer"), new Name("Roy Balakrishnan"), new Phone("92624417"),
    ...
    public static Supplier[] getSampleSuppliers() {
        return new Supplier[] {
                new Supplier(new PersonCategory("Supplier"), new Name("This Is SupplierList"), new Phone("87438807"),
                        new Email("alexyeoh@example.com"), new Address("Blk 30 Geylang Street 29, #06-40"),
                        getTagSet("friends"), null),
                new Supplier(new PersonCategory("Supplier"), new Name("Bernice Yu"), new Phone("99272758"),
                        new Email("berniceyu@example.com"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                        getTagSet("colleagues", "friends"), null),
                new Supplier(new PersonCategory("Supplier"), new Name("Charlotte Oliveiro"), new Phone("93210283"),
                        new Email("charlotte@example.com"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                        getTagSet("neighbours"), null),
                new Supplier(new PersonCategory("Supplier"), new Name("David Li"), new Phone("91031282"),
                        new Email("lidavid@example.com"), new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                        getTagSet("family"), null),
                new Supplier(new PersonCategory("Supplier"), new Name("Irfan Ibrahim"), new Phone("92492021"),
                        new Email("irfan@example.com"), new Address("Blk 47 Tampines Street 20, #17-35"),
                        getTagSet("classmates"), null),
                new Supplier(new PersonCategory("Supplier"), new Name("Roy Balakrishnan"), new Phone("92624417"),
                        new Email("royb@example.com"), new Address("Blk 45 Aljunied Street 85, #11-31"),
    ...
    public static Deliverer[] getSampleDeliverers() {
        return new Deliverer[] {
                new Deliverer(new PersonCategory("Deliverer"), new Name("ThisIs DelivererList"), new Phone("87438807"),
                        new Email("alexyeoh@example.com"), new Address("Blk 30 Geylang Street 29, #06-40"),
                        getTagSet("friends"), null),
                new Deliverer(new PersonCategory("Deliverer"), new Name("Bernice Yu"), new Phone("99272758"),
                        new Email("berniceyu@example.com"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                        getTagSet("colleagues", "friends"), null),
                new Deliverer(new PersonCategory("Deliverer"), new Name("Charlotte Oliveiro"), new Phone("93210283"),
                        new Email("charlotte@example.com"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                        getTagSet("neighbours"), null),
                new Deliverer(new PersonCategory("Deliverer"), new Name("David Li"), new Phone("91031282"),
                        new Email("lidavid@example.com"), new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                        getTagSet("family"), null),
                new Deliverer(new PersonCategory("Deliverer"), new Name("Irfan Ibrahim"), new Phone("92492021"),
                        new Email("irfan@example.com"), new Address("Blk 47 Tampines Street 20, #17-35"),
                        getTagSet("classmates"), null),
                new Deliverer(new PersonCategory("Deliverer"), new Name("Roy Balakrishnan"), new Phone("92624417"),
                        new Email("royb@example.com"), new Address("Blk 45 Aljunied Street 85, #11-31"),
                        getTagSet("colleagues"), null)
