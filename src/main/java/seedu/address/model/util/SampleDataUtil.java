    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"),
                new LessonPlan("Java and C#"), new HomeworkList(), new AttendanceList(), new GradeProgressList(), getTagSet("neighbours")),
            ...
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new LessonPlan("Math"),
                new HomeworkList(), new AttendanceList(), new GradeProgressList(), getTagSet("classmates")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"),
                new LessonPlan("Test papers"), new HomeworkList(), new AttendanceList(), new GradeProgressList(), getTagSet("colleagues"))
        };
    }
