...
public class SampleDataUtil {
    public static Student[] getSampleStudents() {
        return new Student[]{
                new Student(new Name("Alex Yeoh"), new Id("123A"), new Name("Bernice Yu"), new Phone("99272758"),
                ...
                new Student(new Name("Charlotte Oliveiro"), new Id("123A"), new Name("Bernice Yu"), new Phone("93210283"),
                        new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), getTagSet("peanut allergy")),
