    ...
    public static Student[] getSampleStudents() {
        return new Student[]{
            ...
            new Student(new Name("David Yeoh"), new Id("456B"), new Class("1A"), new Name("Bernice Yu"),
                    new Phone("87438807"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                    getTagSet("siblings")),
            new Student(new Name("Charlotte Oliveiro"), new Id("123A"), new Class("2A"),
                    new Name("Bernice Yu"), new Phone("93210283"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
