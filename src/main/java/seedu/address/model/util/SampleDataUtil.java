    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                ...
                getReminderSet(new Pair<>("Wish Alex Yeoh happy birthday!", "1-01-2023")),
                getTagSet("friends")),
            ...
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                ...
                new CriticalIllnessInsurance(true), new LifeInsurance(true),
                getReminderSet(new Pair<>("Wish Charlotte Oliveiro happy birthday!", "1-03-2023")),
            ...
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                ...
                new CriticalIllnessInsurance(true), new LifeInsurance(true),
                getReminderSet(new Pair<>("Wish David Li happy birthday!", "1-05-2023")),
                getTagSet("family")),
            ...
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                ...
                getReminderSet(new Pair<>("Wish Roy Balakrishnan happy birthday!", "1-10-2023")),
