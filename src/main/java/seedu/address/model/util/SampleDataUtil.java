    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                ...
                getTagSet("colleagues", "friends"), new Risk("high"), getPlanSet("NTUC Income plan"),
                getNoteSet("")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new Income("$3080"), new MeetingDate("08 Nov 2022"),
                new MeetingLocation("https://meet.google.com/vim-ejvu-sdh"), getTagSet("neighbours"),
            ...
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                ...
                new MeetingLocation(""), getTagSet("classmates"), new Risk("medium"),
            ...
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                ...
                new MeetingLocation("Blk 45 Aljunied Street 85, #11-31"), getTagSet("colleagues"),
                new Risk("low"), getPlanSet("Singapore Savings Bond"), getNoteSet("is on a holiday"))
        };
    }
