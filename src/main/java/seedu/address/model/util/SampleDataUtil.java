    ...
    public static Person[] getSamplePersons() {
        return new Person[]{
            ...
            new Person(new Occupation("TA"), new Name("Bernice Yu"),
                    ...
                    new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), getTagSet("colleagues", "friends"), new Social()),
            ...
            new Person(new Occupation("STUDENT"), new Name("David Li"),
                    ...
                    new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), getTagSet("family"), new Social()),
