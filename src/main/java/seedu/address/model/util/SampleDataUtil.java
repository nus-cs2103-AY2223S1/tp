    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new LessonPlan("Sec 4 Biology"),
                new HomeworkList(), new GradeProgressList(), getTagSet("friends")),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new LessonPlan("Focus on trigo"),
                new HomeworkList(), new GradeProgressList(), getTagSet("colleagues", "friends")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"),
                new LessonPlan("Java and C#"), new HomeworkList(), new GradeProgressList(), getTagSet("neighbours")),
            new Person(new Name("David Li"), new Phone("91031282"), new LessonPlan("Sec 3 biology"),
                new HomeworkList(), new GradeProgressList(), getTagSet("family")),
