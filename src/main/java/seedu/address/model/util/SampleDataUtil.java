...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[]{
            new Person(new Name("Alex Yeoh"), new IndexNumber("1"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                       ...
                       getTagSet("friends")),
            new Person(new Name("Bernice Yu"), new IndexNumber("2"), new Phone("99272758"), new Email("berniceyu@example.com"),
                       new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new StudentClass("2.1"),
                       new Attendance(), getRemarkSet("family"),
                       new SubjectHandler("english: CA1:[80.0, 100.0, 0.2, 1.0], CA2:[30.0, "
                               + "56.0, 0.4, 2.0] %%math: CA1:[80.0, 100.0, 0.2, 1.0], CA2:[30.0, 56.0, 0.4, 2.0]"),
                       getTagSet("colleagues", "friends")),
            new Person(new Name("Charlotte Oliveiro"), new IndexNumber("3"), new Phone("93210283"), new Email("charlotte@example.com"),
                       new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new StudentClass("3.6"),
                       new Attendance(), getRemarkSet("family"),
                       new SubjectHandler("english: CA1:[80.0, 100.0, 0.2, 1.0], CA2:[30.0, "
                               + "56.0, 0.4, 2.0] %%math: CA1:[80.0, 100.0, 0.2, 1.0], CA2:[30.0, 56.0, 0.4, 2.0]"),
                       getTagSet("neighbours")),
            new Person(new Name("David Li"), new IndexNumber("4"), new Phone("91031282"), new Email("lidavid@example.com"),
                       new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new StudentClass("4.2"),
                       new Attendance(), getRemarkSet("family"),
                       new SubjectHandler("english: CA1:[80.0, 100.0, 0.2, 1.0], CA2:[30.0, "
                               + "56.0, 0.4, 2.0] %%math: CA1:[80.0, 100.0, 0.2, 1.0], CA2:[30.0, 56.0, 0.4, 2.0]"),
                       getTagSet("family")),
            new Person(new Name("Irfan Ibrahim"), new IndexNumber("5"), new Phone("92492021"), new Email("irfan@example.com"),
                       new Address("Blk 47 Tampines Street 20, #17-35"), new StudentClass("2.6"),
                       new Attendance(), getRemarkSet("family"),
                       new SubjectHandler("english: CA1:[80.0, 100.0, 0.2, 1.0], CA2:[30.0, "
                               + "56.0, 0.4, 2.0] %%math: CA1:[80.0, 100.0, 0.2, 1.0], CA2:[30.0, 56.0, 0.4, 2.0]"),
                       getTagSet("classmates")),
            new Person(new Name("Roy Balakrishnan"), new IndexNumber("10"), new Phone("92624417"), new Email("royb@example.com"),
