    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Student(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                ...
                getTagSet("friends"), new School("Geylang Primary School"), Level.PRIMARY5,
            ...
            new Tutor(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                ...
                getTagSet("Teach amath", "Teach emath"), new Qualification("Bachelor of Maths"),
                    new Institution("National University of Singapore")),
            new Student(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                getTagSet("weak in maths"), new School("Ang Mo Kio Secondary School"), Level.SECONDARY3,
            ...
            new Student(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                ...
                getTagSet("needs help in english"), new School("Serangoon Primary School"), Level.PRIMARY5,
                    new NextOfKin(new Name("Dylan Li"), new Phone("85467812"), new Email("lidylan@example.com"),
                            new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                            getTagSet("former student"), Relationship.BROTHER)),
            new Tutor(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), getTagSet("Teaches english"),
                    new Qualification("Bachelor of Arts"), new Institution("Nanyang Technological University")),
            new Student(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Street 85, #11-31"), getTagSet("Weak in maths"),
