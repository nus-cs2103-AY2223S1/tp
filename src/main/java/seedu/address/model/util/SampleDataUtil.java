    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                ...
                getTagSet("friends"), getReminderSet(new Pair<>("Wish Alex Yeoh happy birthday!",
                "1-01-2000"))),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new Birthday("12 January 2000"),
                getTagSet("colleagues", "friends"), getReminderSet(new Pair<>("Wish Bernice Yu happy birthday!",
                    "12-01-2000"))),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new Birthday("1 March 2000"),
                getTagSet("neighbours"), getReminderSet(new Pair<>("Wish Charlotte Oliveiro happy birthday!",
                    "1-03-2000"))),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new Birthday("1 May 2000"),
                getTagSet("family"), getReminderSet(new Pair<>("Wish David Li happy birthday!",
                    "1-05-2000"))),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), new Birthday("25 June 2004"),
                getTagSet("classmates"), getReminderSet(new Pair<>("Wish Irfan Ibrahim happy birthday!",
                    "25-06-2004"))),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Street 85, #11-31"), new Birthday("1 October 1989"),
                getTagSet("colleagues"), getReminderSet(new Pair<>("Wish Roy Balakrishnan happy birthday!",
                    "1-10-1989"))),
        };
    }
