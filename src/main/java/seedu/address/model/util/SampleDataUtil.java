...
public class SampleDataUtil {
    ...
    public static Reminder[] getSampleReminders() {
        return new Reminder[] {
            new Reminder(new ReminderName("Mark Midterms"), toDatetime("20:00"),
                        new ReminderDescription("300 papers to mark")),
            new Reminder(new ReminderName("Send email to TAs"), toDatetime("21:00"),
                        new ReminderDescription("Erratum in midterms")),
            new Reminder(new ReminderName("Meeting with Prof Lee"), toDatetime("22:00"),
    ...
    public static Consultation[] getSampleConsultations() {
        return new Consultation[] {
            new Consultation(new ConsultationName("Anna"), new ConsultationModule("CS2103T"),
                        new ConsultationVenue("COM1-0203"), toDatetimeRange("2022-01-01", "16:00", "18:00"),
            ...
            new Consultation(new ConsultationName("Tom"), new ConsultationModule("CS2103T"),
                        new ConsultationVenue("COM1-0201"), toDatetimeRange("2022-01-01", "15:00", "17:00"),
            ...
            new Consultation(new ConsultationName("John"), new ConsultationModule("CS2103T"),
                        new ConsultationVenue("COM1-0202"), toDatetimeRange("2022-01-01", "10:00", "11:00"),
