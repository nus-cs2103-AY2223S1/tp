    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                ...
                new MeetingDate("12 Nov 2022"), new MeetingLocation("21 Lower Kent Ridge Rd, Singapore 119077"),
                getTagSet("colleagues", "friends")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new Income("$3080"),
                new MeetingDate("12 Nov 2022"), new MeetingLocation("https://meet.google.com/vim-ejvu-sdh"),
                getTagSet("neighbours")),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new Income("$440"),
                new MeetingDate(""), new MeetingLocation(""), getTagSet("family")),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), new Income("$12000"),
                new MeetingDate("12 Nov 2022"), new MeetingLocation(""), getTagSet("classmates")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Street 85, #11-31"), new Income("$800"),
                new MeetingDate("12 Nov 2022"), new MeetingLocation("Blk 45 Aljunied Street 85, #11-31"),
