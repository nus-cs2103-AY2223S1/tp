...
class JsonAdaptedNextOfKin {
    ...
    /**
     * Constructs a {@code JsonAdaptedNextOfKin} with the given person details.
     */
    @JsonCreator
    ...
    public JsonAdaptedNextOfKin(NextOfKin source) {
        ...
        relationship = source.getRelationship().name();
    ...
    /**
     * Converts this Jackson-friendly adapted person object into the model's {@code NextOfKin} object.
     *
    ...
    public NextOfKin toModelType() throws IllegalValueException {
        ...
        final Relationship modelRelationship = Relationship.createRelationship(relationship);

        final Set<Tag> modelTags = new HashSet<>(personTags);

        return new NextOfKin(modelName, modelPhone, modelEmail, modelAddress, modelTags, modelRelationship);
    }
}
