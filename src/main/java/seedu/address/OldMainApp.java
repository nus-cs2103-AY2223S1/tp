...
import seedu.address.logic.OldLogicManager;
...
public class OldMainApp extends Application {
    ...
    public void init() throws Exception {
        ...
        storage = new OldStorageManager(addressBookStorage, userPrefsStorage);
     ...
     */
    private OldModel initModelManager(OldStorage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            initialData = addressBookOptional.orElseGet(OldSampleDataUtil::getSampleAddressBook);
