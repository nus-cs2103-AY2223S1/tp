...
/**
 * A UI component that displays the number of persons in the address book.
 * @author A0214632N
 */
public class PersonCountDisplay extends UiPart<Region> {
    ...
    /**
     * Standard message to be displayed when there are no persons in the address
     * book
     */
    ...
    /**
     * The text flow to display the total count of persons in the address book
     */
    @FXML
     ...
     * @param filteredList The filtered list of persons in the address book
     * @param totalList    The list of all persons in the address book
     */
