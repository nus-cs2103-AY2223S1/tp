...
public class AddLinkCommand extends Command {
    ...
    public static final String MESSAGE_DUPLICATE_LINK = "The link/s already exists in the address book.";
     ...
     * edited with {@code links}.
     */
    private static Module createEditedModule(Module moduleToEdit, Set<Link> linksToEdit) {
        ...
        updatedLinks.addAll(linksToEdit);
