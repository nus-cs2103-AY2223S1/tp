...
public class CloneCommand extends Command {
    ...
    private static Person createClonedPerson(Model model, Person personToClone) {
        ...
        Person clonedPerson = new Person(updatedName, clonedPhone, clonedEmail, clonedAddress, clonedGender, clonedBirthdate, clonedRace, clonedReligion, clonedSurvey, clonedTags);
