...
public class FindStaffCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all staffs in the currently active project "
            + "whose names contains any of the specified keywords (case-insensitive) "
            + "Parameters: "
