...
public class EditCommand extends Command {
    ...
    /**
     * @param index of the person in the filtered supplier list to edit
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        Item updatedItem = editPersonDescriptor.getItem().orElse(personToEdit.getItem());
        Address updatedAddress = editPersonDescriptor.getAddress().orElse(personToEdit.getAddress());
        Set<Tag> updatedTags = editPersonDescriptor.getTags().orElse(personToEdit.getTags());

        return new Person(updatedName, updatedPhone, updatedPrice, updatedItem, updatedAddress, updatedTags);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, phone, price, item, address, tags);
        }
