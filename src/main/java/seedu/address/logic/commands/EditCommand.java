...
import static seedu.address.logic.parser.CliSyntax.PREFIX_MODULE_CLASS;
...
public class EditCommand extends Command {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        Set<ModuleClass> updatedModuleClasses = editPersonDescriptor.getModuleClasses()
                .orElse(personToEdit.getModuleClasses());

        return new Person(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedModuleClasses);
    }
