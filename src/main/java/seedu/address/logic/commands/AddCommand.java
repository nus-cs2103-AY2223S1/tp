...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a person to the list of contacts. "
            + "Parameters: "
            + "-" + FLAG_NAME_STR + " NAME "
    ...
    public static final String MESSAGE_DUPLICATE_PERSON = "This person already exists in the list of contacts";
