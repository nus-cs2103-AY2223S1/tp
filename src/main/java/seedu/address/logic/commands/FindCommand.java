...
public class FindCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        switch (type) {
        case STUDENT_LIST:
            this.studentPredicate = new NameContainsKeywordsPredicate<Student>(keywords);
            model.updateFilteredStudentList(studentPredicate);
            return new CommandResult(
                    String.format(Messages.MESSAGE_STUDENTS_LISTED_OVERVIEW, model.getFilteredStudentList().size()));
        case TUTOR_LIST:
            this.tutorPredicate = new NameContainsKeywordsPredicate<Tutor>(keywords);
        ...
        case TUITIONCLASS_LIST:
            this.classPredicate = new NameContainsKeywordsPredicate<TuitionClass>(keywords);
        ...
        case PERSON_LIST:
            this.personPredicate = new NameContainsKeywordsPredicate<Person>(keywords);
