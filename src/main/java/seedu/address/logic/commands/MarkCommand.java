...
public class MarkCommand extends Command {
    ...
    public static final String MESSAGE_MARK_PERSON_SUCCESS = "Marked appointment for Person: %1$s";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Appointment appointmentToMark = personToMarkFor.getAppointments().get(indexOfAppointment.getZeroBased());
        ...
        return new CommandResult(MESSAGE_MARK_PERSON_SUCCESS);
    }
}
