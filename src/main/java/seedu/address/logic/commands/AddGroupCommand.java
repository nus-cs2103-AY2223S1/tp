...
public class AddGroupCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds an empty group to TABS.\n"
            + "Parameters: "
    ...
    public static final String MESSAGE_DUPLICATE_GROUP = "This group already exists in TABS.";
