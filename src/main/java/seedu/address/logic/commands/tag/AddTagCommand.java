...
public class AddTagCommand extends Command {
     ...
     */
    public AddTagCommand(Index index, EditPersonDescriptor editPersonDescriptor, boolean addTagToContact, boolean addTagToTask, EditTaskDescriptor editTaskDescriptor) {
