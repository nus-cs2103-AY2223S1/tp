...
/**
 * Parses input arguments and creates a new StudentEnrollCommand object
 */
public class StudentEnrollCommandParser implements Parser<StudentEnrollCommand> {

    /**
     * Parses the given {@code String} of arguments in the context of the StudentEnrollCommand
     * and returns an StudentEnrollCommand object for execution.
