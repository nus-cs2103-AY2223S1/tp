...
public class CreateCommandParser implements Parser<CreateCommand> {
    ...
    public CreateCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_ADDRESS, PREFIX_PHONE, PREFIX_NETWORTH,
        ...
        Person person = new Person(name, phone, email, address, remark, netWorth, meetingTime, tagList);
