...
public class AddContactCommandParser implements Parser<AddContactCommand> {
    ...
    public AddContactCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_ADDRESS, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_MODS)
        ...
        Mods mods = ParserUtil.parseMods(argMultimap.getValue(PREFIX_MODS).get());
        Set<Tag> tagList = ParserUtil.parseTags(argMultimap.getAllValues(PREFIX_TAG));

        Person person = new Person(name, phone, email, address, tagList, mods);
