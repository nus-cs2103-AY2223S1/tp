...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
            ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_INDEX_NUMBERS, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS,
        ...
        if (argMultimap.getValue(PREFIX_INDEX_NUMBERS).isPresent()) {
            editPersonDescriptor.setIndexNumber(ParserUtil.parseIndexNumber(argMultimap.getValue(PREFIX_INDEX_NUMBERS).get()));
        }
