...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS,
                        PREFIX_GENDER, PREFIX_BIRTHDATE, PREFIX_RACE, PREFIX_RELIGION, PREFIX_TAG, PREFIX_SURVEY);
        ...
        if (argMultimap.getValue(PREFIX_RELIGION).isPresent()) {
            editPersonDescriptor.setReligion(ParserUtil.parseReligion(argMultimap.getValue(PREFIX_RELIGION).get()));
        }
        parseTagsForEdit(argMultimap.getAllValues(PREFIX_TAG)).ifPresent(editPersonDescriptor::setTags);
        parseSurveysForEdit(argMultimap.getAllValues(PREFIX_SURVEY)).ifPresent(editPersonDescriptor::setSurveys);
     ...
     */
    private Optional<Set<Survey>> parseSurveysForEdit(Collection<String> surveys) throws ParseException {
        assert surveys != null;
