...
/**
 * Parses input arguments and creates a new EditTeachingAssistantCommand object
 */
public class EditTaParser implements Parser<EditTeachingAssistantCommand> {

    /**
     * Parses the given {@code String} of arguments in the context of the EditTeachingAssistantCommand
     * and returns an EditTeachingAssistantCommand object for execution.
     * @throws ParseException if the user input does not conform the expected format
     */
    public EditTeachingAssistantCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        return new EditTeachingAssistantCommand(index, editStudentDescriptor);
    }
