 ...
 */
public class NewAddCommandParser implements Parser<NewAddCommand> {
     ...
     */
    public NewAddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_COMPANY, PREFIX_CONTACT, PREFIX_EMAIL, PREFIX_POSITION, PREFIX_DATE)
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, NewAddCommand.MESSAGE_USAGE));
        }
        ...
        return new NewAddCommand(application);
    }
