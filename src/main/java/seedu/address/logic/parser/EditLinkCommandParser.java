...
//                throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditLinkCommand
//                .MESSAGE_USAGE));
//            }
//
//            Index index;
...
//            }
        ...
        return new EditLinkCommand(Index.fromOneBased(0), new EditLinkCommand.EditLinkDescriptor());
