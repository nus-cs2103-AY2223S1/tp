...
import seedu.address.logic.commands.AnyTagCommissionCommand;
...
/**
 * Parses input arguments and creates a new AnyTagCommissionCommand object
 */
public class AnyTagCommissionCommandParser {
    /**
     ...
     */
    public AnyTagCommissionCommand parse(String args) throws ParseException {
        ...
        tags.addAll(tagSet);
        return new AnyTagCommissionCommand(new CommissionContainsAnyTagPredicate(tags));
    }
}
