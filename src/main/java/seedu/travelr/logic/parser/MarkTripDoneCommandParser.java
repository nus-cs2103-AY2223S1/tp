...
/**
 * Parses input arguments and creates a new MarkTripDoneCommand object.
 */
public class MarkTripDoneCommandParser implements Parser<MarkTripDoneCommand> {

    /**
     * Parses the given {@code String} of arguments in the context of the MarkTripDoneCommand
     * and returns an MarkTripDoneCommand object for execution.
     *
