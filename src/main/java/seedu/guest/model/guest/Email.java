...
/**
 * Represents a Guest's email in the guest book.
...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format local-part@domain "
            ...
            + "the parentheses, (" + SPECIAL_CHARACTERS + "). These special characters cannot be adjacent to each "
            + "other. The local-part may not start or end with any special "
    ...
    public static boolean isValidEmail(String test) {
        return test.matches(VALIDATION_REGEX) && test.split("@")[0].length() <= MAX_LOCAL_LENGTH
                && test.split("@")[1].length() <= MAX_DOMAIN_LENGTH;
    }
