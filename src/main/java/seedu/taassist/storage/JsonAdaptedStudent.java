...
class JsonAdaptedStudent {
    ...
    public static final String MESSAGE_MISSING_FIELD_FORMAT = "Some student's %s field is missing!";
    ...
    public Student toModelType() throws IllegalValueException {
        if (name == null) {
            throw new IllegalValueException(String.format(MESSAGE_MISSING_FIELD_FORMAT, Name.class.getSimpleName()));
        }
        ...
        if (phone == null) {
            throw new IllegalValueException(String.format(MESSAGE_MISSING_FIELD_FORMAT, Phone.class.getSimpleName()));
        }
        ...
        if (email == null) {
            throw new IllegalValueException(String.format(MESSAGE_MISSING_FIELD_FORMAT, Email.class.getSimpleName()));
        }
        ...
        if (address == null) {
            throw new IllegalValueException(String.format(MESSAGE_MISSING_FIELD_FORMAT, Address.class.getSimpleName()));
        }
