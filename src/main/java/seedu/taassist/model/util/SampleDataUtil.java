    ...
    private static List<Student> getSampleStudents() {
        return List.of(
            new Student(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                ...
                getModuleDataList(CS1231S)).updateGrade(CS1231S, ASSIGNMENT_1, 100.0),
            new Student(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getModuleDataList(CS1101S, CS1231S)).updateGrade(CS1101S, LAB_1, 50.0),
            new Student(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                getModuleDataList(CS1231S)).updateGrade(CS1231S, ASSIGNMENT_1, 50.0),
            new Student(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                getModuleDataList(CS1101S)).updateGrade(CS1101S, LAB_1, 100.0),
            new Student(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"),
                getModuleDataList(CS1231S)).updateGrade(CS1231S, TUTORIAL_1, 1.0),
