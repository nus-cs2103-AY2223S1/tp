...
public class SampleDataUtil {
    ...
    private static final List<StudentModuleData> DEFAULT_STUDENT_MODULE_DATA_CS1231S =
            List.of(new StudentModuleData(new ModuleClass("CS1231S"), DEFAULT_SESSION_DATA_LIST));
    private static final List<StudentModuleData> DEFAULT_STUDENT_MODULE_DATA_CS1101S =
        List.of(new StudentModuleData(new ModuleClass("CS1101S"), DEFAULT_SESSION_DATA_LIST));

    public static Student[] getSampleStudents() {
        return new Student[] {
            new Student(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                new Address("Blk 30 Geylang Street 29, #06-40"),
                getModuleClassSet("CS1231S"), DEFAULT_STUDENT_MODULE_DATA_CS1231S),
            new Student(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getModuleClassSet("CS1101S", "CS1231S"), DEFAULT_STUDENT_MODULE_DATA_CS1101S),
            ...
            new Student(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                ...
                getModuleClassSet("CS1101S"), DEFAULT_STUDENT_MODULE_DATA_CS1101S)
        };
    }
    ...
    public static Set<ModuleClass> getModuleClassSet(String... strings) {
        return Arrays.stream(strings)
                .map(name -> new ModuleClass(name, List.of(new Session("Lab 1"))))
