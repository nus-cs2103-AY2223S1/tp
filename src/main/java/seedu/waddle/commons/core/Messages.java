...
public class Messages {
    ...
    public static final String MESSAGE_CONFLICTING_ITEMS = "Oh no! There is a time clash! The provided time clashes with:" +
            "\n%1$s\nPlease change the start time and/or the duration.";
