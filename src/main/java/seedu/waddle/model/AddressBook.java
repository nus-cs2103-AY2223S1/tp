...
public class AddressBook implements ReadOnlyAddressBook {
    ...
    public void setPersons(List<Itinerary> itineraries) {
        this.persons.setPersons(itineraries);
    }
    ...
    public boolean hasPerson(Itinerary itinerary) {
        ...
        return persons.contains(itinerary);
    }
     ...
     */
    public void addPerson(Itinerary p) {
        persons.add(p);
    }
    ...
    public void setPerson(Itinerary target, Itinerary editedItinerary) {
        ...
        persons.setPerson(target, editedItinerary);
    }
     ...
     */
    public void removePerson(Itinerary key) {
        persons.remove(key);
    }
