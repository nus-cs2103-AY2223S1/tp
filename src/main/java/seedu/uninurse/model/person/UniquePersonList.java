 ...
 * A person is considered unique by comparing using {@code Patient#isSamePerson(Patient)}. As such, adding and
 * updating of persons uses Patient#isSamePerson(Patient) for equality so as to ensure that the person being added
