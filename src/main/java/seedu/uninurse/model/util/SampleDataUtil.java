    ...
    public static Patient[] getSamplePersons() {
        return new Patient[] {
            ...
            new Patient(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                ...
                getTaskList(new Task("Change dressing on right arm", new DateTime("2022-10-16T10:15:30"))),
                getTagSet("colleagues", "friends")),
            new Patient(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                getTaskList(new Task("Check blood glucose level", new DateTime("2022-10-16T10:15:30")),
                        new Task("Administer insulin dose", new DateTime("2022-10-16T10:15:30"))),
