...
/**
 * Finds and lists all internships in address book whose company name contains any of the argument keywords.
...
public class FindCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all internships whose company name contains any of "
