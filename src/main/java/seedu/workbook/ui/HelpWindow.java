...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String ADD_COMMAND = "add c/COMPANY r/ROLE s/STAGE [d/DATE] [e/EMAIL] "
            + "[l/PROGRAMMING LANGUAGE]… [t/TAG]…";
    public static final String EDIT_COMMAND = "edit INDEX [c/COMPANY] [r/ROLE] [s/STAGE] [d/DATE] [e/EMAIL] "
            + "[l/PROGRAMMING LANGUAGE]… [t/TAG]…";
