    ...
    public static Item[] getSampleItems() {
        return new Item[]{
            new Item(new ItemName("Milk"),
                     new ItemQuantity("2"),
                     new ItemUnit("litres"),
                     new ItemBoughtDate("18-03-2022"),
                     new ItemExpiryDate("28-04-2022"),
                     new ItemPrice("3.40"),
            ...
            new Item(new ItemName("Bread"),
                     new ItemQuantity("3"),
                     new ItemUnit("loaves"),
                     new ItemBoughtDate("28-03-2022"),
                     new ItemExpiryDate("20-05-2022"),
                     new ItemPrice("2.40"),
            ...
            new Item(new ItemName("Eggs"),
                     new ItemQuantity("10"),
                     new ItemUnit("trays"),
                     new ItemBoughtDate("28-10-2022"),
                     new ItemExpiryDate("25-01-2022"),
                     new ItemPrice("3.30"),
                     new ItemRemark("For seasonal meal"),
                     new HashSet<>()),
            new Item(new ItemName("Local Cheese"),
                     new ItemQuantity("2"),
                     new ItemUnit(""),
                     new ItemBoughtDate("17-04-2022"),
                     new ItemExpiryDate("28-10-2022"),
                     new ItemPrice("25"),
                     new ItemRemark(""),
                     new HashSet<>()),
            new Item(new ItemName("Water"),
                     new ItemQuantity("10"),
                     new ItemUnit("litres"),
                     new ItemBoughtDate("13-05-2022"),
                     new ItemExpiryDate("13-01-2022"),
                     new ItemPrice("1.40"),
                     new ItemRemark(""),
                     new HashSet<>(List.of(new Tag("Drinks"), new Tag("Fridge")))),
            new Item(new ItemName("Wine"),
                     ...
                     new ItemBoughtDate("21-06-2022"),
                     new ItemExpiryDate("21-04-2022"),
                     new ItemPrice("30"),
                     new ItemRemark(""),
                     new HashSet<>(List.of(new Tag("Drinks"), new Tag("Fridge")))),
            new Item(new ItemName("Domestic Beer"),
                     ...
                     new ItemUnit("cans"),
                     new ItemBoughtDate("22-09-2022"),
                     new ItemExpiryDate("21-11-2022"),
                     new ItemPrice("5.00"),
                     new ItemRemark(""),
                     new HashSet<>(List.of(new Tag("Drinks"), new Tag("Fridge")))),
            new Item(new ItemName("Imported Beer"),
                     new ItemQuantity("100"),
                     new ItemUnit("cans"),
                     new ItemBoughtDate("24-06-2022"),
                     new ItemExpiryDate("23-12-2022"),
                     new ItemPrice("5.90"),
                     new ItemRemark(""),
                     new HashSet<>(List.of(new Tag("Drinks"), new Tag("Fridge")))),
            new Item(new ItemName("Chicken breasts"),
                     ...
                     new ItemUnit("Kg"),
                     new ItemBoughtDate("24-08-2022"),
                     new ItemExpiryDate("16-04-2022"),
                     new ItemPrice("11"),
            ...
            new Item(new ItemName("Apples"),
                     ...
                     new ItemUnit("Kg"),
                     new ItemBoughtDate("14-01-2022"),
                     new ItemExpiryDate("15-11-2022"),
                     new ItemPrice("4.80"),
                     new ItemRemark("Try new recipe"),
            ...
            new Item(new ItemName("Oranges"),
                     ...
                     new ItemUnit("Kg"),
                     new ItemBoughtDate("18-09-2022"),
                     new ItemExpiryDate("10-04-2022"),
                     new ItemPrice("4.40"),
                     new ItemRemark("For seasonal meal"),
                     new HashSet<>(List.of(new Tag("Fruits")))),
            new Item(new ItemName("Potatoes"),
                     ...
                     new ItemUnit("Kg"),
                     new ItemBoughtDate("14-11-2022"),
                     new ItemExpiryDate("24-10-2022"),
                     new ItemPrice("2.80"),
                     new ItemRemark("For seasonal meal"),
            ...
            new Item(new ItemName("Lettuce"),
                     ...
                     new ItemUnit("Kg"),
                     new ItemBoughtDate("28-05-2022"),
                     new ItemExpiryDate("14-07-2022"),
                     new ItemPrice("2.20"),
                     new ItemRemark(""),
                     new HashSet<>(List.of(new Tag("Vegetables")))),
            new Item(new ItemName("Rice"),
                     new ItemQuantity("10"),
                     new ItemUnit("Kg"),
                     new ItemBoughtDate("18-01-2022"),
                     new ItemExpiryDate("12-05-2022"),
                     new ItemPrice("3.20"),
                     new ItemRemark(""),
                     new HashSet<>()),
            new Item(new ItemName("Tomato"),
                     ...
                     new ItemUnit("Kg"),
                     new ItemBoughtDate("22-01-2022"),
                     new ItemExpiryDate("10-07-2022"),
                     new ItemPrice("3.60"),
                     new ItemRemark(""),
                     new HashSet<>(List.of(new Tag("Fruits")))),
            ...
            new Item(new ItemName("Onions"),
                     ...
                     new ItemUnit("Kg"),
                     new ItemBoughtDate("21-03-2022"),
                     new ItemExpiryDate("11-06-2022"),
                     new ItemPrice("2.80"),
                     new ItemRemark(""),
                     new HashSet<>(List.of(new Tag("Fruits")))),
            new Item(new ItemName("Beef Round"),
                     new ItemQuantity("10"),
                     new ItemUnit("Kg"),
                     new ItemBoughtDate("22-12-2022"),
                     new ItemExpiryDate("19-07-2022"),
                     new ItemPrice("28"),
                     new ItemRemark("Try new recipe"),
                     new HashSet<>(List.of(new Tag("Meat"), new Tag("Freezer")))),
            new Item(new ItemName("Pears"),
                     new ItemQuantity("2"),
                     new ItemUnit("Kg"),
                     new ItemBoughtDate("24-07-2022"),
                     new ItemExpiryDate("17-10-2022"),
                     new ItemPrice("5.80"),
                     new ItemRemark("Try new recipe"),
                     new HashSet<>(List.of(new Tag("Fruits")))),
            new Item(new ItemName("Cucumber"),
                     new ItemQuantity("4"),
                     new ItemUnit("Kg"),
                     new ItemBoughtDate("21-07-2022"),
                     new ItemExpiryDate("19-04-2022"),
                     new ItemPrice("2.00"),
                     new ItemRemark(""),
                     new HashSet<>(List.of(new Tag("Vegetables")))),
            new Item(new ItemName("Perrier Water"),
                     ...
                     new ItemUnit("litres"),
                     new ItemBoughtDate("27-07-2022"),
                     new ItemExpiryDate("20-09-2022"),
                     new ItemPrice("0.78"),
                     new ItemRemark(""),
                     new HashSet<>(List.of(new Tag("Drinks"), new Tag("Fridge")))),
            new Item(new ItemName("Sausages"),
                     new ItemQuantity("3"),
                     new ItemUnit("kg"),
                     new ItemBoughtDate("10-05-2022"),
                     new ItemExpiryDate("17-09-2022"),
                     new ItemPrice("38"),
                     new ItemRemark(""),
                     new HashSet<>(List.of(new Tag("Meat"), new Tag("Freezer")))),
            new Item(new ItemName("Cottage cheese"),
                     new ItemQuantity("2"),
                     new ItemUnit("kg"),
                     new ItemBoughtDate("10-02-2022"),
                     new ItemExpiryDate("18-03-2022"),
                     new ItemPrice("20"),
                     new ItemRemark(""),
                     new HashSet<>(List.of(new Tag("Vegetables")))),
            new Item(new ItemName("Whisky"),
                     new ItemQuantity("10"),
                     new ItemUnit("litres"),
                     new ItemBoughtDate("15-12-2022"),
                     new ItemExpiryDate("14-11-2022"),
                     new ItemPrice("58"),
                     new ItemRemark("For party"),
                     new HashSet<>(List.of(new Tag("Drinks"), new Tag("Fridge")))),
            new Item(new ItemName("Rum"),
                     ...
                     new ItemUnit("litres"),
                     new ItemBoughtDate("13-04-2022"),
                     new ItemExpiryDate("17-06-2022"),
                     new ItemPrice("58"),
                     new ItemRemark("For party"),
                     new HashSet<>(List.of(new Tag("Drinks"), new Tag("Fridge")))),
            new Item(new ItemName("Vodka"),
                     ...
                     new ItemUnit("litres"),
                     new ItemBoughtDate("18-10-2022"),
                     new ItemExpiryDate("11-04-2022"),
                     new ItemPrice("58"),
                     new ItemRemark("For party"),
                     new HashSet<>(List.of(new Tag("Drinks"), new Tag("Fridge")))),
            new Item(new ItemName("Gin"),
                     new ItemQuantity("3"),
                     new ItemUnit("litres"),
                     new ItemBoughtDate("28-06-2022"),
                     new ItemExpiryDate("26-01-2022"),
                     new ItemPrice("58"),
                     new ItemRemark("For party"),
                     new HashSet<>(List.of(new Tag("Drinks"), new Tag("Fridge")))),
        };
