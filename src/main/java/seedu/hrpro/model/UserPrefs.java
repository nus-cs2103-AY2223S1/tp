...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    private Path hrProFilePath = Paths.get("data" , "hrpro.json");
    ...
    public boolean equals(Object other) {
        ...
        return guiSettings.equals(o.guiSettings)
                && hrProFilePath.equals(o.hrProFilePath);
    }

    @Override
    public int hashCode() {
        return Objects.hash(guiSettings, hrProFilePath);
    }
    ...
    public String toString() {
        ...
        sb.append("\nLocal data file location : " + hrProFilePath);
        return sb.toString();
    }
