...
public class MainWindow extends UiPart<Stage> {
    ...
    void fillInnerParts() {
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getNutriGoalsFilePath());
        statusbarPlaceholder.getChildren().add(statusBarFooter.getRoot());

        CommandBox commandBox = new CommandBox(this::executeCommand);
        commandBoxPlaceholder.getChildren().add(commandBox.getRoot());

        progressBarController = new ProgressBarController(logic.getCalorieIntakeProgress());
        progressBarPlaceholder.getChildren().add(progressBarController.getRoot());
    }
     ...
     *
     * @see seedu.nutrigoals.logic.Logic#execute(String)
     */
