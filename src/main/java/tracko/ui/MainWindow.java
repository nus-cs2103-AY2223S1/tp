...
public class MainWindow extends UiPart<Stage> {
    ...
    @FXML
    private StackPane listsPanelPlaceholder;
     ...
     */
    void fillInnerParts() {
        orderListPanel = new OrderListPanel(logic.getOrderList());
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getOrdersFilePath());
    ...
    public OrderListPanel getPersonListPanel() {
