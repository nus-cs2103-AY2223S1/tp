...
/**
 * Parses input arguments and creates a new CustomiseHideCommand object.
 */
public class CustomiseHideCommandParser implements Parser<CustomiseHideCommand> {

    /**
     * Parses the given String of arguments in the context of the CustomiseHideCommand
     * and returns a CustomiseHideCommand object for execution.
     *
     * @param args Remaining user input string.
     * @return The command based on the user input.
     * @throws ParseException If the user input does not conform the expected format.
     */
    public CustomiseHideCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        if (!hasArguments || hasNonEmptyArgument(argList)) {
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, CustomiseHideCommand.MESSAGE_USAGE));
        }
        ...
        return new CustomiseHideCommand(attributeList);
    }
}
