...
public class SampleDataUtil {
    public static Eatery[] getSamplePersons() {
        return new Eatery[] {
            new Eatery(new Name("Alex Yeoh"), new Phone("87438807"), new Cuisine("alexyeoh@example.com"),
                new Location("Blk 30 Geylang Street 29, #06-40"),
                getTagSet("friends")),
            new Eatery(new Name("Bernice Yu"), new Phone("99272758"), new Cuisine("berniceyu@example.com"),
                new Location("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getTagSet("colleagues", "friends")),
            new Eatery(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Cuisine("charlotte@example.com"),
                new Location("Blk 11 Ang Mo Kio Street 74, #11-04"),
                getTagSet("neighbours")),
            new Eatery(new Name("David Li"), new Phone("91031282"), new Cuisine("lidavid@example.com"),
                new Location("Blk 436 Serangoon Gardens Street 26, #16-43"),
                getTagSet("family")),
            new Eatery(new Name("Irfan Ibrahim"), new Phone("92492021"), new Cuisine("irfan@example.com"),
                new Location("Blk 47 Tampines Street 20, #17-35"),
                getTagSet("classmates")),
            new Eatery(new Name("Roy Balakrishnan"), new Phone("92624417"), new Cuisine("royb@example.com"),
