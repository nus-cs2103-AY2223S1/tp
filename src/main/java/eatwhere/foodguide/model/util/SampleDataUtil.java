...
public class SampleDataUtil {
    public static Eatery[] getSamplePersons() {
        return new Eatery[] {
            new Eatery(new Name("Arise n Shine"), new Price(""), new Cuisine("snacks"),
                new Location("Engineering Block E4"),
                getTagSet()),
            new Eatery(new Name("Arise n Shine 2"), new Price(""), new Cuisine("snacks"),
                new Location("Science Block S16"),
                getTagSet()),
            new Eatery(new Name("Frontier"), new Price(""), new Cuisine("variety"),
                new Location("Faculty of Science"),
                getTagSet("foodcourt")),
            new Eatery(new Name("The Deck"), new Price(""), new Cuisine("variety"),
                new Location("Faculty of Arts & Social Sciences"),
                getTagSet("foodcourt")),
            new Eatery(new Name("KOI"), new Price("69933323"), new Cuisine("bubble tea"),
                new Location("Central Square"),
                getTagSet()),
            new Eatery(new Name("Techno Edge"), new Price(""), new Cuisine("variety"),
