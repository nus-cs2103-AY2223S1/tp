...
public class LessonWeeks extends AbstractOpenApiSchema {
    ...
    public static class LessonWeeksDeserializer extends StdDeserializer<LessonWeeks> {
        ...
        public LessonWeeksDeserializer(Class<?> vc) {
            super(vc);
        }
        ...
        public LessonWeeks deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(WeekRange.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'WeekRange'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'WeekRange'", e);
            }

            if (match == 1) {
                LessonWeeks ret = new LessonWeeks();
