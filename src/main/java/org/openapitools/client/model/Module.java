...
public class Module {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acadYear, preclusion, description, title, department, faculty, workload, prerequisite, moduleCredit, moduleCode, semesterData, prereqTree, fulfillRequirements);
  }
