...
/**
 * Parses input arguments and creates a new TaskEventCommand object.
 */
public class TaskEventCommandParser implements Parser<TaskEventCommand> {
    ...
    /**
     * Parses the given {@code String} of arguments in the context of the TaskEventCommand
     * and returns an TaskEventCommand object for execution.
     *
    ...
    private TaskEventCommand parseWithoutPrefix(String args) throws ParseException {
        ...
        return new TaskEventCommand(Name.SELF, description, Assignment.TO, date, tagList);
    }
