...
public class SampleDataUtil {
    public static Tutor[] getSampleTutors() {
        return new Tutor[] {
            new Tutor(new Name("Alex Yeoh"), new Phone("87438807"), new Email("e0234567"),
            ...
            new Tutor(new Name("Bernice Yu"), new Phone("99272758"), new Email("e0234527"),
            ...
            new Tutor(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("e3498732"),
