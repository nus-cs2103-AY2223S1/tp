...
public class CommandTestUtil {
    ...
    public static final String PROJECTNAME_DESC_AMY = " " + PREFIX_PROJECT_NAME + VALID_PROJECTNAME_AMY;
    public static final String PROJECTNAME_DESC_BOB = " " + PREFIX_PROJECT_NAME + VALID_PROJECTNAME_BOB;
    ...
    public static final String INVALID_PROJECTNAME_DESC = " " + PREFIX_PROJECT_NAME;
