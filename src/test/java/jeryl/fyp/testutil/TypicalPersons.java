...
public class TypicalPersons {
    ...
    public static final Student CARL = new PersonBuilder().withName("Carl Kurz").withStudentID("A1352563C")
            .withEmail("heinz@example.com").withAddress("wall street")
            .withProjectName("B+ Tree").build();
    public static final Student DANIEL = new PersonBuilder().withName("Daniel Meier").withStudentID("A1652533D")
            .withEmail("cornelia@example.com").withAddress("10th street").withTags("friends")
            .withProjectName("Soft Engineering").build();
    public static final Student ELLE = new PersonBuilder().withName("Elle Meyer").withStudentID("A1482224E")
            .withEmail("werner@example.com").withAddress("michegan ave")
            .withProjectName("database design").build();
    public static final Student FIONA = new PersonBuilder().withName("Fiona Kunz").withStudentID("A1482427F")
            .withEmail("lydia@example.com").withAddress("little tokyo")
            .withProjectName("rasterization in game development").build();
    public static final Student GEORGE = new PersonBuilder().withName("George Best").withStudentID("A1482442G")
            .withEmail("anna@example.com").withAddress("4th street")
            .withProjectName("programming language").build();

    // Manually added
    public static final Student HOON = new PersonBuilder().withName("Hoon Meier").withStudentID("A1482424H")
            .withEmail("stefan@example.com").withAddress("little india")
            .withProjectName("Robotics").build();
    public static final Student IDA = new PersonBuilder().withName("Ida Mueller").withStudentID("A1482131I")
            .withEmail("hans@example.com").withAddress("chicago ave")
            .withProjectName("computer network").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final Student AMY = new PersonBuilder().withName(VALID_NAME_AMY).withStudentID(VALID_STUDENTID_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
            .withProjectName(VALID_PROJECTNAME_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Student BOB = new PersonBuilder().withName(VALID_NAME_BOB).withStudentID(VALID_STUDENTID_BOB)
