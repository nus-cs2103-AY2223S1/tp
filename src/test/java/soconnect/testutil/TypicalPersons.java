...
import static soconnect.logic.commands.CommandTestUtil.VALID_ADDRESS_AMY;
import static soconnect.logic.commands.CommandTestUtil.VALID_ADDRESS_BOB;
import static soconnect.logic.commands.CommandTestUtil.VALID_EMAIL_AMY;
import static soconnect.logic.commands.CommandTestUtil.VALID_EMAIL_BOB;
import static soconnect.logic.commands.CommandTestUtil.VALID_NAME_AMY;
import static soconnect.logic.commands.CommandTestUtil.VALID_NAME_BOB;
import static soconnect.logic.commands.CommandTestUtil.VALID_PHONE_AMY;
...
public class TypicalPersons {
    ...
    /**
     * Returns an {@code SoConnect} with all the typical persons.
     */
    public static SoConnect getTypicalSoConnect() {
        SoConnect ab = new SoConnect();
