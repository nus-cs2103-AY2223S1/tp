...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedStudent person =
                new JsonAdaptedStudent(null, VALID_TELEGRAMHANDLE, VALID_CONSULTATION, VALID_MASTERYCHECK, false,
    ...
    public void toModelType_nullTelegramHandle_throwsIllegalValueException() {
        JsonAdaptedStudent person =
                new JsonAdaptedStudent(VALID_NAME, null, VALID_CONSULTATION, VALID_MASTERYCHECK, false,
                        VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent person =
                new JsonAdaptedStudent(VALID_NAME, VALID_TELEGRAMHANDLE, VALID_CONSULTATION, VALID_MASTERYCHECK,
                        false, VALID_REMARK, invalidTags);
    ...
    public void toModelType_nullConsultation_throwsIllegalValueException() {
        JsonAdaptedStudent person =
                new JsonAdaptedStudent(VALID_NAME, VALID_TELEGRAMHANDLE, null, VALID_MASTERYCHECK, false,
                        VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullMasteryCheck_throwsIllegalValueException() {
        JsonAdaptedStudent person =
                new JsonAdaptedStudent(VALID_NAME, VALID_TELEGRAMHANDLE, VALID_CONSULTATION, null, false,
                        VALID_REMARK, VALID_TAGS);
