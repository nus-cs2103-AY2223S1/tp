...
public class JsonAdaptedDebtTest {
    ...
    public void toModelType_validDetails_returnsDebt() throws IllegalValueException {
        JsonAdaptedDebt debt = new JsonAdaptedDebt(VALID_DESCRIPTION, VALID_MONEY, VALID_IS_PAID, VALID_DATE, VALID_TIME);
        assertEquals(CHICKEN_RICE, debt.toModelType());
    }

    @Test
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedDebt debt = new JsonAdaptedDebt(INVALID_DESCRIPTION, VALID_MONEY, VALID_IS_PAID, VALID_DATE, VALID_TIME);
    ...
    public void toModelType_invalidMoney_throwsIllegalValueException() {
        JsonAdaptedDebt debt = new JsonAdaptedDebt(VALID_DESCRIPTION, INVALID_MONEY, VALID_IS_PAID, VALID_DATE, VALID_TIME);
