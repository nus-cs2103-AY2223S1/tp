...
public class CommandTestUtil {
    ...
    public static final String VALID_TITLE_GETMOTIVATED = "Get Motivated";
    public static final String VALID_AUTHOR_LCT = "Lim Chee Teck";
     ...
     * - BookFace, filtered person list and selected person in {@code actualModel} remain unchanged
     */
