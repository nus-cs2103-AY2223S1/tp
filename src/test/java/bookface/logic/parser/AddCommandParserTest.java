...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, AddUserCommand.COMMAND_WORD_USER
        ...
        assertParseSuccess(parser, AddUserCommand.COMMAND_WORD_USER + CommandTestUtil.NAME_DESC_BOB
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, AddUserCommand.COMMAND_WORD_USER
