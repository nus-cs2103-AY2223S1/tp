...
public class CommandTestUtil {
    ...
    public static final String EMAIL_DESC_AMY = " " + PREFIX_CUISINE + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_CUISINE + VALID_EMAIL_BOB;
    ...
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_CUISINE + "bob!yahoo"; // missing '@' symbol
