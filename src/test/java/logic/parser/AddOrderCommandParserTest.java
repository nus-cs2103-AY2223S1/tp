...
import static logic.commands.CommandTestUtil.ADDRESS_DESC_AMY;
import static logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
import static logic.commands.CommandTestUtil.EMAIL_DESC_AMY;
import static logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static logic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static logic.commands.CommandTestUtil.INVALID_PHONE_DESC;
...
import static logic.commands.CommandTestUtil.ITEM_NAME_DESC_BOB;
import static logic.commands.CommandTestUtil.NAME_DESC_AMY;
import static logic.commands.CommandTestUtil.NAME_DESC_BOB;
import static logic.commands.CommandTestUtil.PHONE_DESC_AMY;
import static logic.commands.CommandTestUtil.PHONE_DESC_BOB;
...
public class AddOrderCommandParserTest {
    ...
    public void parseAndUpdate_compulsoryFieldMissing_failure() {
        ...
        try {
            parser.parseAndUpdate(QUANTITY_DESC_AMY, baseCommand);
        ...
        try {
            parser.parseAndUpdate(ITEM_NAME_DESC_AMY, baseCommand);
            throw new AssertionError("The expected ParseException was not thrown.");
        } catch (ParseException e) {
            assertEquals(expectedMessage, e.getMessage());
        }
    ...
    public void parseAndUpdate_invalidValue_failure() {
        ...
        try {
            parser.parseAndUpdate(ITEM_NAME_DESC_BOB + INVALID_QUANTITY_DESC, baseCommand);
            throw new AssertionError("The expected ParseException was not thrown.");
        } catch (ParseException e) {
