...
public class CommandTestUtil {
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        List<Tutor> expectedFilteredList = new ArrayList<>(actualModel.getTutorList());

        assertThrows(CommandException.class, expectedMessage, () -> command.execute(actualModel));
        assertEquals(expectedTuthub, actualModel.getTuthub());
        assertEquals(expectedFilteredList, actualModel.getTutorList());
    }
    /**
    ...
    public static void showTutorAtIndex(Model model, Index targetIndex) {
        assertTrue(targetIndex.getZeroBased() < model.getTutorList().size());

        Tutor tutor = model.getTutorList().get(targetIndex.getZeroBased());
        ...
        assertEquals(1, model.getTutorList().size());
    }
