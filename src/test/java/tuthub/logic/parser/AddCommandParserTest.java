...
import static tuthub.logic.commands.CommandTestUtil.INVALID_RATING_DESC;
...
import static tuthub.logic.commands.CommandTestUtil.INVALID_TEACHINGNOMINATION_DESC;
...
import static tuthub.logic.commands.CommandTestUtil.RATING_DESC_BOB;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + MODULE_DESC_BOB
                + YEAR_DESC_AMY + YEAR_DESC_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB + RATING_DESC_BOB
                + TAG_DESC_FRIEND,
                new AddCommand(expectedTutor));

        // multiple student ids - last student id accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + MODULE_DESC_BOB
                + YEAR_DESC_AMY + YEAR_DESC_BOB + STUDENTID_DESC_AMY + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB
                + RATING_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTutor));
        ...
        // multiple teaching nomination - last teaching nomination accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + MODULE_DESC_BOB
                + YEAR_DESC_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_AMY + TEACHINGNOMINATION_DESC_BOB
                + RATING_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTutor));

        // multiple ratings - last teaching nomination accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + MODULE_DESC_BOB
                + YEAR_DESC_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_AMY + TEACHINGNOMINATION_DESC_BOB
                + RATING_DESC_AMY + RATING_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTutor));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + VALID_MODULE_BOB + YEAR_DESC_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB + RATING_DESC_BOB,
            expectedMessage);

        // missing year prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_DESC_BOB + VALID_YEAR_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB + RATING_DESC_BOB,
            expectedMessage);

        // missing student id prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + MODULE_DESC_BOB + YEAR_DESC_BOB + VALID_STUDENTID_BOB
                        + TEACHINGNOMINATION_DESC_BOB + RATING_DESC_BOB,
                expectedMessage);

        // missing teaching nomination prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_DESC_BOB + YEAR_DESC_BOB + STUDENTID_DESC_BOB
                + VALID_TEACHINGNOMINATION_BOB + RATING_DESC_BOB,
            expectedMessage);
        // missing teaching nomination prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + MODULE_DESC_BOB + YEAR_DESC_BOB + STUDENTID_DESC_BOB
                        + TEACHINGNOMINATION_DESC_BOB + VALID_RATING_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB
                + VALID_MODULE_BOB + VALID_YEAR_BOB + VALID_STUDENTID_BOB
                + VALID_TEACHINGNOMINATION_BOB + VALID_RATING_BOB,
                expectedMessage);
    }

    @Test
    public void parse_invalidValue_failure() {
        System.out.println(INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_DESC_BOB + YEAR_DESC_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB
                + RATING_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND);
        // invalid name
        ...
        // invalid module
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
            + INVALID_MODULE_DESC + YEAR_DESC_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB
            + RATING_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
            Module.MESSAGE_CONSTRAINTS);

        // invalid year
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
            + MODULE_DESC_BOB + INVALID_YEAR_DESC + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB
            + RATING_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
            Year.MESSAGE_CONSTRAINTS);

        // invalid student id
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_DESC_BOB + YEAR_DESC_BOB + INVALID_STUDENTID_DESC + TEACHINGNOMINATION_DESC_BOB
                + RATING_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                StudentId.MESSAGE_CONSTRAINTS);

        // invalid teaching nomination
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_DESC_BOB + YEAR_DESC_BOB + STUDENTID_DESC_BOB + INVALID_TEACHINGNOMINATION_DESC
                + RATING_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                TeachingNomination.MESSAGE_CONSTRAINTS);

        // invalid rating
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_DESC_BOB + YEAR_DESC_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB
                + INVALID_RATING_DESC + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Rating.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
            + MODULE_DESC_BOB + YEAR_DESC_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB
            + RATING_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND,
