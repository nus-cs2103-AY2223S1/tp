...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_DESC_BOB + YEAR_DESC_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB + TAG_DESC_FRIEND,
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + MODULE_DESC_BOB
            + YEAR_DESC_AMY + YEAR_DESC_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedTutor));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + VALID_MODULE_BOB + YEAR_DESC_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB,
            expectedMessage);

        // missing year prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_DESC_BOB + VALID_YEAR_BOB + STUDENTID_DESC_BOB + TEACHINGNOMINATION_DESC_BOB,
            expectedMessage);

        // missing student id prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + MODULE_DESC_BOB + YEAR_DESC_BOB + VALID_STUDENTID_BOB + TEACHINGNOMINATION_DESC_BOB,
                expectedMessage);

        // missing teaching nomination prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + MODULE_DESC_BOB + YEAR_DESC_BOB + STUDENTID_DESC_BOB + VALID_TEACHINGNOMINATION_BOB,
            expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB
                + VALID_MODULE_BOB + VALID_YEAR_BOB + VALID_STUDENTID_BOB + VALID_TEACHINGNOMINATION_BOB,
                expectedMessage);
    }
