...
public class EditPersonDescriptorTest {
    ...
    public void equals() {
        ...
        EditCommand.EditPersonDescriptor
            descriptorWithSameValues = new EditCommand.EditPersonDescriptor(CommandTestUtil.DESC_AMY);
        ...
        EditCommand.EditPersonDescriptor editedAmy = new EditPersonDescriptorBuilder(CommandTestUtil.DESC_AMY).withName(
