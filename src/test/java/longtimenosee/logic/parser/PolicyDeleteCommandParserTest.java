 ...
 */
public class PolicyDeleteCommandParserTest {

    private PolicyDeleteCommandParser parser = new PolicyDeleteCommandParser();

    @Test
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "1", new PolicyDeleteCommand(INDEX_FIRST_POLICY));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a", String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                PolicyDeleteCommand.MESSAGE_USAGE));
    }
}
