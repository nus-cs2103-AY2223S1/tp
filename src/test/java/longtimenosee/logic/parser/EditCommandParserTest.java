...
import static longtimenosee.testutil.TypicalIndexes.INDEX_THIRD_PERSON;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        ...
        // invalid prefix being parsed as preamble, changed from i since i is now valid
        assertParseFailure(parser, "1 la/ string", MESSAGE_INVALID_FORMAT);
    }
