...
import static longtimenosee.storage.JsonAdaptedPerson.MISSING_FIELD_MESSAGE_FORMAT;
import static longtimenosee.testutil.Assert.assertThrows;
import static longtimenosee.testutil.TypicalPersons.BENSON;
...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_RISK_APPETITE = BENSON.getRiskAppetite().toString();

    private static final List<JsonAdaptedTag> VALID_TAGS = BENSON.getTags().stream()
            .map(JsonAdaptedTag::new)
            .collect(Collectors.toList());

    //TODO: To implement dummy list of assigned policies
    private static final List<JsonAdaptedAssignedPolicy> VALID_POLICIES = new ArrayList<>();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                        VALID_BIRTHDAY, VALID_INCOME, VALID_RISK_APPETITE, false, VALID_POLICIES);
