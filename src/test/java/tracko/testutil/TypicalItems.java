...
public class TypicalItems {
    ...
    public static final InventoryItem DEFAULT_INVENTORY_ITEM = new ItemBuilder().build();

    // Following items to be instantiated as a test InventoryList
    public static final InventoryItem INVENTORY_ITEM_1 = new ItemBuilder().withItemName("Sofa")
            .withQuantity(200).withDescription("Made of leather")
            .withSellPrice(150.00)
            .withCostPrice(50.00).build();
    public static final InventoryItem INVENTORY_ITEM_2 = new ItemBuilder().withItemName("Bed")
            .withQuantity(50).withDescription("Comes with linen")
            .withSellPrice(200.00)
            .withCostPrice(50.00).build();
    public static final InventoryItem INVENTORY_ITEM_3 = new ItemBuilder().withItemName("School Bag")
            .withQuantity(3).withDescription("Suitable for secondary kids")
            .withSellPrice(34.00)
            .withCostPrice(5.00).build();
    public static final InventoryItem INVENTORY_ITEM_4 = new ItemBuilder().withItemName("Dining Table")
            .withQuantity(25).withDescription("Comes with table cloth")
            .withSellPrice(199.99)
            .withCostPrice(49.99).build();
    public static final InventoryItem INVENTORY_ITEM_5 = new ItemBuilder().withItemName("Pants")
            .withQuantity(52).withDescription("Made with denim")
            .withSellPrice(40.0)
            .withCostPrice(50.0).build();
    public static final InventoryItem INVENTORY_ITEM_6 = new ItemBuilder().withItemName("Bed")
            .withQuantity(50).withDescription("Comes with linen")
            .withSellPrice(199.9)
            .withCostPrice(49.9).build();
    public static final InventoryItem INVENTORY_ITEM_7 = new ItemBuilder().withItemName("Slippers")
            .withQuantity(48).withDescription("Cute shark slippers")
            .withSellPrice(10.00)
            .withCostPrice(2.00).build();

    // Manually added
    public static final InventoryItem INVENTORY_ITEM_8 = new ItemBuilder().withItemName("Keychain")
            .withQuantity(95).withDescription("Small copper keychain")
            .withSellPrice(0.50)
            .withCostPrice(4.99).build();
    public static final InventoryItem INVENTORY_ITEM_9 = new ItemBuilder().withItemName("Mechanical Pencil")
            .withQuantity(278).withDescription("Mechanical pencil with rubber grip")
            .withSellPrice(0.30)
            .withCostPrice(2.50).build();

    // Manually added
    public static final InventoryItem INVENTORY_ITEM_10 = new ItemBuilder().withItemName("Eraser")
            .withQuantity(209).withDescription("Plastic eraser")
            .withSellPrice(0.05)
            .withCostPrice(0.70).build();
    public static final InventoryItem INVENTORY_ITEM_11 = new ItemBuilder().withItemName("Stapler")
