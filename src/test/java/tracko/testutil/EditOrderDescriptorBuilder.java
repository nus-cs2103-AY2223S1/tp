...
public class EditOrderDescriptorBuilder {
    ...
    public EditOrderDescriptorBuilder withItemList() {
        ...
        defaultPairList.add(new ItemQuantityPairBuilder().withItem(TypicalItems.INVENTORY_ITEM_2).withQuantity(10).build());
    ...
    public EditOrderDescriptorBuilder withSecondItemList() {
        List<ItemQuantityPair> defaultPairList = new ArrayList<>();
        defaultPairList.add(new ItemQuantityPairBuilder().withItem(TypicalItems.INVENTORY_ITEM_5).withQuantity(25).build());
        defaultPairList.add(new ItemQuantityPairBuilder().withItem(TypicalItems.INVENTORY_ITEM_4).withQuantity(20).build());
        descriptor.setItemList(defaultPairList);
        return this;
    }
