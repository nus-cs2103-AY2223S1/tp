...
import static hobbylist.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        expectedModel.addPerson(expectedActivity);
     ...
     */
    private static class JsonHobbyListIoExceptionThrowingStub extends JsonHobbyListStorage {
        private JsonHobbyListIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
