...
public class JsonAdaptedActivityTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        ...
        JsonAdaptedActivity activity =
                new JsonAdaptedActivity(INVALID_NAME, VALID_DESCRIPTION, VALID_TAGS, dateList);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        ...
        dateList.add(new JsonAdaptedDate(VALID_DATE));
        JsonAdaptedActivity activity =
                new JsonAdaptedActivity(VALID_NAME, INVALID_DESCRIPTION, VALID_TAGS, dateList);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedActivity activity =
                new JsonAdaptedActivity(VALID_NAME, VALID_DESCRIPTION, invalidTags, dateList);
