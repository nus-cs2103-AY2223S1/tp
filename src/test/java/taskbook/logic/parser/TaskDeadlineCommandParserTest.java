...
import taskbook.logic.parser.tasks.TaskDeadlineCommandParser;
import taskbook.model.person.Name;
import taskbook.model.task.Description;
import taskbook.model.task.enums.Assignment;

public class TaskDeadlineCommandParserTest {

    private TaskDeadlineCommandParser parser = new TaskDeadlineCommandParser();
    ...
    public void parse_doubleAssignmentFields_failure() {
        String expectedMessage = String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT,
                TaskDeadlineCommand.MESSAGE_USAGE);
