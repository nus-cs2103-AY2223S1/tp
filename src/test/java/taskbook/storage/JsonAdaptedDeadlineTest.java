...
public class JsonAdaptedDeadlineTest {
    ...
    public void toModelType_validDeadlineDetails_returnsTask() throws Exception {
        TaskBook taskBook = new TaskBook();
        taskBook.addPerson(TypicalTaskBook.ALICE);
        JsonAdaptedTask task = new JsonAdaptedDeadline(VALID_NAME, VALID_ASSIGNMENT,
                VALID_DESCRIPTION, true, VALID_DEADLINE, VALID_TAGS);
        Assertions.assertEquals(TypicalTaskBook.EATING, task.toModelType());
    }
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        TaskBook taskBook = new TaskBook();
        taskBook.addPerson(TypicalTaskBook.ALICE);
        JsonAdaptedTask task = new JsonAdaptedDeadline(INVALID_NAME, VALID_ASSIGNMENT,
                VALID_DESCRIPTION, true, VALID_DEADLINE, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        TaskBook taskBook = new TaskBook();
        taskBook.addPerson(TypicalTaskBook.ALICE);
        JsonAdaptedTask task = new JsonAdaptedDeadline(null, VALID_ASSIGNMENT,
                VALID_DESCRIPTION, true, VALID_DEADLINE, VALID_TAGS);
    ...
    public void toModelType_invalidAssignment_throwsIllegalValueException() {
        TaskBook taskBook = new TaskBook();
        taskBook.addPerson(TypicalTaskBook.ALICE);
        JsonAdaptedTask task = new JsonAdaptedDeadline(VALID_NAME, INVALID_ASSIGNMENT,
                VALID_DESCRIPTION, true, VALID_DEADLINE, VALID_TAGS);
    ...
    public void toModelType_nullAssignment_throwsIllegalValueException() {
        TaskBook taskBook = new TaskBook();
        taskBook.addPerson(TypicalTaskBook.ALICE);
        JsonAdaptedTask task = new JsonAdaptedDeadline(VALID_NAME, null,
                VALID_DESCRIPTION, true, VALID_DEADLINE, VALID_TAGS);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        ...
        taskBook.addPerson(TypicalTaskBook.ALICE);
        JsonAdaptedTask task = new JsonAdaptedDeadline(VALID_NAME, VALID_ASSIGNMENT,
                INVALID_DESCRIPTION, true, VALID_DEADLINE, VALID_TAGS);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        ...
        taskBook.addPerson(TypicalTaskBook.ALICE);
        JsonAdaptedTask task = new JsonAdaptedDeadline(VALID_NAME, VALID_ASSIGNMENT,
                null, true, VALID_DEADLINE, VALID_TAGS);
    ...
    public void toModelType_invalidDeadline_throwsIllegalValueException() {
        ...
        taskBook.addPerson(TypicalTaskBook.ALICE);
        JsonAdaptedTask task = new JsonAdaptedDeadline(VALID_NAME, VALID_ASSIGNMENT,
                VALID_DESCRIPTION, true, INVALID_DEADLINE, VALID_TAGS);
    ...
    public void toModelType_nullDeadline_throwsIllegalValueException() {
        ...
        taskBook.addPerson(TypicalTaskBook.ALICE);
        JsonAdaptedTask task = new JsonAdaptedDeadline(VALID_NAME, VALID_ASSIGNMENT,
                VALID_DEADLINE, true, null, VALID_TAGS);
    ...
    public void toModelType_invalidTag_throwsIllegalValueException() {
        ...
        JsonAdaptedTask task = new JsonAdaptedDeadline(VALID_NAME, VALID_ASSIGNMENT,
                null, true, VALID_DEADLINE, invalidTags);
