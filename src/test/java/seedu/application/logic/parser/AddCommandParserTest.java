...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE
                + DATE_DESC_GOOGLE + EMAIL_DESC_GOOGLE + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY,
                new AddCommand(expectedApplication));

        // multiple companies - last company accepted
        assertParseSuccess(parser, COMPANY_DESC_FACEBOOK + COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE
                + DATE_DESC_GOOGLE + EMAIL_DESC_GOOGLE + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY,
                new AddCommand(expectedApplication));

        // multiple contacts - last contact accepted
        assertParseSuccess(parser, COMPANY_DESC_GOOGLE + CONTACT_DESC_FACEBOOK + CONTACT_DESC_GOOGLE
                + DATE_DESC_GOOGLE + EMAIL_DESC_GOOGLE + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY,
                new AddCommand(expectedApplication));

        // multiple dates - last date accepted
        assertParseSuccess(parser, COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE + DATE_DESC_FACEBOOK
                + DATE_DESC_GOOGLE + EMAIL_DESC_GOOGLE + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY,
                new AddCommand(expectedApplication));

        // multiple emails - last email accepted
        assertParseSuccess(parser, COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE + EMAIL_DESC_FACEBOOK
                        + DATE_DESC_GOOGLE + EMAIL_DESC_GOOGLE + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY,
                new AddCommand(expectedApplication));

        // multiple positions - last position accepted
        assertParseSuccess(parser, COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE + EMAIL_DESC_GOOGLE
                        + DATE_DESC_GOOGLE + POSITION_DESC_FACEBOOK + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY,
                new AddCommand(expectedApplication));
        ...
        assertParseSuccess(parser, COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE + EMAIL_DESC_GOOGLE
                + DATE_DESC_GOOGLE + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY + TAG_DESC_PREFERRED,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_COMPANY_GOOGLE + CONTACT_DESC_GOOGLE + DATE_DESC_GOOGLE
                + EMAIL_DESC_GOOGLE + POSITION_DESC_GOOGLE, expectedMessage);
        ...
        assertParseFailure(parser, COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE + DATE_DESC_GOOGLE
                + VALID_EMAIL_GOOGLE + POSITION_DESC_GOOGLE, expectedMessage);

        // missing position prefix
        assertParseFailure(parser, COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE + DATE_DESC_GOOGLE
                + EMAIL_DESC_GOOGLE + VALID_POSITION_GOOGLE, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_COMPANY_GOOGLE + VALID_CONTACT_GOOGLE + VALID_DATE_GOOGLE
                + VALID_EMAIL_GOOGLE + VALID_POSITION_GOOGLE, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_COMPANY_DESC + CONTACT_DESC_GOOGLE + DATE_DESC_GOOGLE
                + EMAIL_DESC_GOOGLE + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY + TAG_DESC_PREFERRED,
                Company.MESSAGE_CONSTRAINTS);

        // invalid contact
        assertParseFailure(parser, COMPANY_DESC_GOOGLE + INVALID_CONTACT_DESC + DATE_DESC_GOOGLE
                + EMAIL_DESC_GOOGLE + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY + TAG_DESC_PREFERRED,
                Contact.MESSAGE_CONSTRAINTS);

        // invalid date
        assertParseFailure(parser, COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE + INVALID_DATE_DESC
                + EMAIL_DESC_GOOGLE + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY + TAG_DESC_PREFERRED,
                Date.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE + DATE_DESC_GOOGLE
                + INVALID_EMAIL_DESC + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY + TAG_DESC_PREFERRED,
                Email.MESSAGE_CONSTRAINTS);

        // invalid position
        assertParseFailure(parser, COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE + DATE_DESC_GOOGLE
                + EMAIL_DESC_GOOGLE + INVALID_POSITION_DESC + TAG_DESC_TECH_COMPANY + TAG_DESC_PREFERRED,
                Position.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE + DATE_DESC_GOOGLE
                + EMAIL_DESC_GOOGLE + POSITION_DESC_GOOGLE + INVALID_TAG_DESC + VALID_TAG_TECH_COMPANY,
                Tag.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_COMPANY_DESC + CONTACT_DESC_GOOGLE + DATE_DESC_GOOGLE
                + INVALID_EMAIL_DESC + POSITION_DESC_GOOGLE, Company.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + COMPANY_DESC_GOOGLE + CONTACT_DESC_GOOGLE
                        + DATE_DESC_GOOGLE + EMAIL_DESC_GOOGLE + POSITION_DESC_GOOGLE + TAG_DESC_TECH_COMPANY
