...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_MSFT + POSITION_DESC_MSFT + EMAIL_DESC_MSFT
                + WEBSITE_DESC_MSFT + SALARY_DESC_MSFT + TAG_DESC_REMOTE, new AddCommand(expectedInternship));

        // multiple names - last name accepted
        assertParseSuccess(parser, NAME_DESC_AAPL + NAME_DESC_MSFT + POSITION_DESC_MSFT + EMAIL_DESC_MSFT
                + WEBSITE_DESC_MSFT + SALARY_DESC_MSFT + TAG_DESC_REMOTE, new AddCommand(expectedInternship));

        // multiple positions - last name accepted
        assertParseSuccess(parser, NAME_DESC_MSFT + POSITION_DESC_AAPL + POSITION_DESC_MSFT
                + EMAIL_DESC_MSFT + WEBSITE_DESC_MSFT + SALARY_DESC_MSFT
                + TAG_DESC_REMOTE, new AddCommand(expectedInternship));
        ...
        assertParseSuccess(parser, NAME_DESC_MSFT + POSITION_DESC_MSFT + EMAIL_DESC_MSFT
                + WEBSITE_DESC_MSFT + SALARY_DESC_MSFT + TAG_DESC_REMOTE + TAG_DESC_URGENT,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_MSFT + POSITION_DESC_MSFT
                + EMAIL_DESC_MSFT + WEBSITE_DESC_MSFT + SALARY_DESC_MSFT, new AddCommand(expectedInternship));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_MSFT + POSITION_DESC_MSFT + EMAIL_DESC_MSFT
                + WEBSITE_DESC_MSFT + SALARY_DESC_MSFT, expectedMessage);

        // missing name prefix
        assertParseFailure(parser, NAME_DESC_MSFT + VALID_POSITION_MSFT + EMAIL_DESC_MSFT
                + WEBSITE_DESC_MSFT + SALARY_DESC_MSFT, expectedMessage);

        // missing salary prefix
        assertParseFailure(parser, NAME_DESC_MSFT + POSITION_DESC_MSFT + EMAIL_DESC_MSFT
                + WEBSITE_DESC_MSFT + VALID_SALARY_MSFT, expectedMessage);

        // missing email prefix
        assertParseFailure(parser, NAME_DESC_MSFT + POSITION_DESC_MSFT + VALID_EMAIL_MSFT
                + WEBSITE_DESC_MSFT + SALARY_DESC_MSFT, expectedMessage);

        // missing website prefix
        assertParseFailure(parser, NAME_DESC_MSFT + POSITION_DESC_MSFT + EMAIL_DESC_MSFT
                + VALID_WEBSITE_MSFT + SALARY_DESC_MSFT, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_MSFT + VALID_POSITION_MSFT + VALID_EMAIL_MSFT
                + VALID_WEBSITE_MSFT + VALID_SALARY_MSFT, expectedMessage);
    }

    @Test
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + POSITION_DESC_MSFT + EMAIL_DESC_MSFT + WEBSITE_DESC_MSFT
                + SALARY_DESC_MSFT + TAG_DESC_URGENT + TAG_DESC_REMOTE, Name.MESSAGE_CONSTRAINTS);

        // invalid position
        assertParseFailure(parser, NAME_DESC_MSFT + INVALID_POSITION_DESC + EMAIL_DESC_MSFT + WEBSITE_DESC_MSFT
                + SALARY_DESC_MSFT + TAG_DESC_URGENT + TAG_DESC_REMOTE, Position.MESSAGE_CONSTRAINTS);

        // invalid salary
        assertParseFailure(parser, NAME_DESC_MSFT + POSITION_DESC_MSFT + EMAIL_DESC_MSFT + WEBSITE_DESC_MSFT
                + INVALID_SALARY_DESC + TAG_DESC_URGENT + TAG_DESC_REMOTE, Salary.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_MSFT + POSITION_DESC_MSFT + INVALID_EMAIL_DESC + WEBSITE_DESC_MSFT
                + SALARY_DESC_MSFT + TAG_DESC_URGENT + TAG_DESC_REMOTE, Email.MESSAGE_CONSTRAINTS);

        // invalid website
        assertParseFailure(parser, NAME_DESC_MSFT + POSITION_DESC_MSFT + EMAIL_DESC_MSFT + INVALID_WEBSITE_DESC
                        + SALARY_DESC_MSFT + TAG_DESC_URGENT + TAG_DESC_REMOTE,
                Website.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_MSFT + POSITION_DESC_MSFT + EMAIL_DESC_MSFT + WEBSITE_DESC_MSFT
                + SALARY_DESC_MSFT + INVALID_TAG_DESC + VALID_TAG_REMOTE, Tag.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + POSITION_DESC_MSFT + EMAIL_DESC_MSFT
                + INVALID_WEBSITE_DESC + SALARY_DESC_MSFT, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_MSFT + POSITION_DESC_MSFT + EMAIL_DESC_MSFT
                        + WEBSITE_DESC_MSFT + SALARY_DESC_MSFT + TAG_DESC_URGENT + TAG_DESC_REMOTE,
