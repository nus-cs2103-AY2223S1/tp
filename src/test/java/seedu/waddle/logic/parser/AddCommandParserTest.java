...
import static seedu.waddle.logic.commands.CommandTestUtil.NAME_DESC_BOB;
...
import static seedu.waddle.testutil.TypicalPersons.AMY;
import static seedu.waddle.testutil.TypicalPersons.BOB;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Itinerary expectedItinerary = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedItinerary));
        ...
        Itinerary expectedItineraryMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, new AddCommand(expectedItineraryMultipleTags));
    }

    @Test
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Itinerary expectedItinerary = new PersonBuilder(AMY).withTags().build();
