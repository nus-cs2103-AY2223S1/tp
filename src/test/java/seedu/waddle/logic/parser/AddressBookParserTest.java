...
public class AddressBookParserTest {
    ...
    public void parseCommand_add() throws Exception {
        ...
        AddCommand command = (AddCommand) parser.parseCommand(PersonUtil.getAddCommand(itinerary));
    ...
    public void parseCommand_edit() throws Exception {
        Itinerary itinerary = new PersonBuilder().build();
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder(itinerary).build();
