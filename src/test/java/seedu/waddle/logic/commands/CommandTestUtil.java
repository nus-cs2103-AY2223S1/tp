...
public class CommandTestUtil {
    ...
    public static final String INVALID_NAME_DESC = " " + PREFIX_NAME + "Spring&"; // '&' not allowed in names
    public static final String INVALID_COUNTRY_DESC = " " + PREFIX_COUNTRY + "911*"; // '*' not allowed in countries
    public static final String INVALID_START_DATE_DESC = " " + PREFIX_START_DATE + "2023/05/04"; // improper date format
    public static final String INVALID_END_DATE_DESC = " " + PREFIX_END_DATE + "Sunday"; // improper date format
    public static final String INVALID_PEOPLE_DESC = " " + PREFIX_PEOPLE + "ten"; // non-numeric not allowed in people
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        Itinerary person = model.getFilteredItineraryList().get(targetIndex.getZeroBased());
