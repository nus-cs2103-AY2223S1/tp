...
public class PersonBuilder {
     ...
     */
    public PersonBuilder(Itinerary itineraryToCopy) {
        name = itineraryToCopy.getName();
        phone = itineraryToCopy.getPhone();
        email = itineraryToCopy.getEmail();
        address = itineraryToCopy.getAddress();
        tags = new HashSet<>(itineraryToCopy.getTags());
    }
    ...
    public Itinerary build() {
        return new Itinerary(name, phone, email, address, tags);
    }
