...
public class EditPersonDescriptorBuilder {
     ...
     */
    public EditPersonDescriptorBuilder(Itinerary itinerary) {
        descriptor = new EditPersonDescriptor();
        descriptor.setName(itinerary.getName());
        descriptor.setPhone(itinerary.getPhone());
        descriptor.setEmail(itinerary.getEmail());
        descriptor.setAddress(itinerary.getAddress());
        descriptor.setTags(itinerary.getTags());
    }
