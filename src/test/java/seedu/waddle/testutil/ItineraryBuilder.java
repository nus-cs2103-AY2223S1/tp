...
public class ItineraryBuilder {
    ...
    public static final String DEFAULT_NAME = "Winter Trip";
    public static final String DEFAULT_COUNTRY = "Korea";
    public static final String DEFAULT_START_DATE = "2022-12-01";
    public static final String DEFAULT_END_DATE = "2022-12-31";
    public static final String DEFAULT_PEOPLE = "5";
