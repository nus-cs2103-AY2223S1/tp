...
public class ScoresCommandParserTest {
    ...
    public void parse_emptyUserInput_failure() {
        assertParseFailure(parser, PREAMBLE_WHITESPACE,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, ScoresCommand.MESSAGE_USAGE));
    }

    @Test
    public void parse_missingPrefix_failure() {
        assertParseFailure(parser, VALID_SESSION_LAB1, String.format(MESSAGE_INVALID_COMMAND_FORMAT,
    ...
    public void parse_prefixWithEmptySession_failure() {
        assertParseFailure(parser, PREFIX_SESSION + PREAMBLE_WHITESPACE,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, ScoresCommand.MESSAGE_USAGE));
    }
