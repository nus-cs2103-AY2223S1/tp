...
import static seedu.classify.logic.commands.CommandTestUtil.INVALID_TAG_DESC;
...
import static seedu.classify.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static seedu.classify.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
...
import static seedu.classify.logic.commands.CommandTestUtil.VALID_TAG_FRIEND;
...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + ID_DESC_AMY + EMAIL_DESC_AMY + STUDENT_NAME_DESC_AMY + CLASS_DESC_AMY + TAG_DESC_FRIEND;
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + EMAIL_DESC_AMY + ID_DESC_AMY
                + TAG_DESC_FRIEND + PHONE_DESC_AMY + EMAIL_DESC_AMY + ID_DESC_AMY + TAG_DESC_FRIEND
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ID_DESC_BOB + TAG_DESC_HUSBAND;

        EditStudentDescriptor descriptor = new EditStudentDescriptorBuilder().withPhone(VALID_PHONE_BOB)
                .withId(VALID_ID_BOB).withEmail(VALID_EMAIL_BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
