...
public class CommandParserTestUtil {
     ...
     */
    public static void assertParseSuccess(ModQuikParser parser, String userInput,
     ...
     */
    public static void assertParseFailure(ModQuikParser parser, String userInput, String expectedMessage) {
        try {
