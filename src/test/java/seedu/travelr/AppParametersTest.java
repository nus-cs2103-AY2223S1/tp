...
public class AppParametersTest {
    ...
    private final seedu.travelr.AppParameters expected = new seedu.travelr.AppParameters();
    ...
    public void parse_validConfigPath_success() {
        ...
        assertEquals(expected, seedu.travelr.AppParameters.parse(parametersStub));
    }
