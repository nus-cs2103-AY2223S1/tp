...
public class TypicalTrips {
    ...
    public static final Trip GERMANY = new TripBuilder().withTitle(VALID_TITLE_GERMANY).withDescription(VALID_DESCRIPTION_GERMANY)
           .withEvents(VALID_EVENT_EATING).build();
    public static final Trip ANTARCTICA = new TripBuilder().withTitle(VALID_TITLE_ANTARCTICA).withDescription(VALID_DESCRIPTION_ANTARCTICA)
            .withEvents(VALID_EVENT_SIGHTSEEING, VALID_EVENT_EATING)
            .build();
