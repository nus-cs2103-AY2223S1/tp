 ...
 */
public class AddEventToTripCommandParserTest {

    private AddEventToTripCommandParser parser = new AddEventToTripCommandParser();

    @Test
    public void parse_validArgs_returnsAddEventToTripCommand() {
        assertParseSuccess(parser, " n/asd t/asd", new AddEventToTripCommand(new Title("asd"), new Title("asd")));
    }
