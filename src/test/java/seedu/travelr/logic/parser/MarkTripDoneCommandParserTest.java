 ...
 */
public class MarkTripDoneCommandParserTest {

    private MarkTripDoneCommandParser parser = new MarkTripDoneCommandParser();

    @Test
    public void parse_validArgs_returnsMarkTripDoneCommand() {
        assertParseSuccess(parser, "1", new MarkTripDoneCommand(Index.fromOneBased(1)));
    }

    @Test
    public void parse_emptyArgs_throwsParseException() {
        assertParseFailure(parser, "", String.format(
                "Index cannot be empty." + "\n\n" + MESSAGE_INVALID_COMMAND_FORMAT, MarkTripDoneCommand.MESSAGE_USAGE));
    }
