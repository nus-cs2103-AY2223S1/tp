...
import static seedu.codeconnect.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
import static seedu.codeconnect.testutil.TypicalPersons.AMY;
...
public class LogicManagerTest {
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        String addContactCommand = AddContactCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + MODULE_DESC_CS1101 + GITHUB_DESC_AMY + TELEGRAM_DESC_AMY;
