...
public class GuestBookParserTest {
    ...
    public void parseCommand_resetRoomClean() throws Exception {
        assertTrue(parser.parseCommand(ResetRoomCleanCommand.COMMAND_WORD) instanceof ResetRoomCleanCommand);
        assertTrue(parser.parseCommand(ResetRoomCleanCommand.COMMAND_WORD + " 3")
                instanceof ResetRoomCleanCommand);
    }
