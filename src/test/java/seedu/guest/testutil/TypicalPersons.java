...
public class TypicalPersons {
    ...
    public static final Guest ALICE = new GuestBuilder().withName("Alice Pauline")
            .withEmail("alice@example.com").withNumberOfGuests("1")
            .withPhone("94351253")
            .build();
