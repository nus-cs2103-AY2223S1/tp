...
public class JsonAdaptedGuestTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedGuest person = new JsonAdaptedGuest(null, VALID_PHONE, VALID_EMAIL, VALID_NUMBER_OF_GUESTS,
                VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedGuest person = new JsonAdaptedGuest(VALID_NAME, null, VALID_EMAIL, VALID_NUMBER_OF_GUESTS,
                VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedGuest person = new JsonAdaptedGuest(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NUMBER_OF_GUESTS,
                null, VALID_TAGS);
