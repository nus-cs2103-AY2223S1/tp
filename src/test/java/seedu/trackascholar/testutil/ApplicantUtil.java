...
public class ApplicantUtil {
    ...
    public static String getApplicantDetails(Applicant applicant) {
        ...
        applicant.getMajors().stream().forEach(
            major -> sb.append(PREFIX_MAJOR + major.getMajorName() + " ")
        );
        return sb.toString();
    }
