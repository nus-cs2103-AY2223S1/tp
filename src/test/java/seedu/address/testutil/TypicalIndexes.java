...
public class TypicalIndexes {
    ...
    public static Index INDEX_FIRST = Index.fromOneBased(1);
    public static Index INDEX_SECOND = Index.fromOneBased(2);
    public static Index INDEX_THIRD = Index.fromOneBased(3);
