...
public class TypicalInternships {
    ...
    public static final Internship CARL = new InternshipBuilder().withName("Carl Kurz").withPhone("95352563")
            .withPosition("Frontend Engineer").withEmail("heinz@example.com").withAddress("wall street").withStatus("Offered").build();
    ...
    public static final Internship ELLE = new InternshipBuilder().withName("Elle Meyer").withPhone("9482224")
            .withPosition("Full Stack Engineer").withEmail("werner@example.com").withAddress("michegan ave").withStatus("Offered").build();
    public static final Internship FIONA = new InternshipBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withPosition("Cyber Security Analyst").withEmail("lydia@example.com").withAddress("little tokyo").withStatus("Offered").build();
    public static final Internship GEORGE = new InternshipBuilder().withName("George Best").withPhone("9482442")
            .withPosition("Algorithm Engineer").withEmail("anna@example.com").withAddress("4th street").withStatus("Offered").build();

    // Manually added
    public static final Internship HOON = new InternshipBuilder().withName("Hoon Meier").withPhone("8482424")
            .withPosition("Product Designer").withEmail("stefan@example.com").withStatus("Offered").withAddress("little india").build();
    public static final Internship IDA = new InternshipBuilder().withName("Ida Mueller").withPhone("8482131")
            .withPosition("Data Engineer").withEmail("hans@example.com").withStatus("Offered").withAddress("chicago ave").build();

    // Manually added - Internship's details found in {@code CommandTestUtil}
    public static final Internship AMY = new InternshipBuilder().withName(VALID_NAME_AMY).withPosition(VALID_POSITION_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withStatus(VALID_STATUS_AMY).withAddress(VALID_ADDRESS_AMY)
            .withTags(VALID_TAG_FRIEND).build();
    public static final Internship BOB = new InternshipBuilder().withName(VALID_NAME_BOB).withPosition(VALID_POSITION_BOB).withPhone(VALID_PHONE_BOB)
