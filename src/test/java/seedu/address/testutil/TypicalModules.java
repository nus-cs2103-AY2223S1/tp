...
public class TypicalModules {
    ...
    public static final Module CS2106_WITH_TYPICAL_TASKS =
            new ModuleBuilder().withModuleCode(VALID_CS_MODULE_CODE).withTasks(VALID_TASKS)
            .withModuleTitle(VALID_CS_MODULE_TITLE).build();
    public static final Module MA2001_WITH_TYPICAL_TASKS =
            new ModuleBuilder().withModuleCode(VALID_MA_MODULE_CODE).withTasks(VALID_TASKS)
                    .withModuleTitle(VALID_MA_MODULE_TITLE).build();
