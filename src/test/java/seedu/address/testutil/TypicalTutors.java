...
import static seedu.address.logic.commands.CommandTestUtil.VALID_TEACHING_INFO_BOB;
...
public class TypicalTutors {
    ...
    public static final Student BOB = new StudentBuilder(new PersonBuilder().withName(VALID_NAME_BOB)
            ...
            .withStudentInfo(VALID_INFO_BOB).withTeachingInfo(VALID_TEACHING_INFO_BOB).build();
