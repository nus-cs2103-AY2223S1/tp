...
import static seedu.address.logic.commands.CommandTestUtil.VALID_DEADLINE_REMINDER2;
...
public class TypicalReminders {
    ...
    public static final Reminder REMINDER1 = new ReminderBuilder().withName("Mark question 4 of test 1")
            .withDeadline("14:00").withDescription("200 more to go").build();
    public static final Reminder REMINDER2 = new ReminderBuilder().withName("Set paper for test 2")
            .withDeadline("15:00").withDescription("3 more questions to set").build();
    public static final Reminder REMINDER3 = new ReminderBuilder().withName("Zoom makeup tut")
            .withDeadline("16:00").withDescription("Tutorial 4 makeup").build();
    public static final Reminder REMINDER4 = new ReminderBuilder().withName("Upload HW1")
            .withDeadline("17:00").withDescription("HW1 of CS2030").build();
    public static final Reminder REMINDER5 = new ReminderBuilder().withName("Upload zoom recording")
            .withDeadline("18:00").withDescription("For lecture 4").build();

    // Manually added
    public static final Reminder MEETING_9AM = new ReminderBuilder().withName("Meeting at 9am").withDeadline("08:45")
            .withDescription("with Prof Anne").build();
    public static final Reminder MEETING_10AM = new ReminderBuilder().withName("Meeting at 10am").withDeadline("09:45")
            .withDescription("with Dean").build();
    ...
    public static final Reminder SET_HW1 = new ReminderBuilder().withName(VALID_NAME_REMINDER1)
            .withDeadline(VALID_DEADLINE_REMINDER1).withDescription(VALID_DESCRIPTION_REMINDER1).build();
    public static final Reminder MARK_FINALS = new ReminderBuilder().withName(VALID_NAME_REMINDER2)
            .withDeadline(VALID_DEADLINE_REMINDER2).withDescription(VALID_DESCRIPTION_REMINDER2).build();
