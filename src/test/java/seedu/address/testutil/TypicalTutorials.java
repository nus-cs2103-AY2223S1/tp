...
import static seedu.address.logic.commands.CommandTestUtil.VALID_TIMESLOT_TUT1;
import static seedu.address.logic.commands.CommandTestUtil.VALID_TIMESLOT_TUT2;
...
public class TypicalTutorials {
    ...
    public static final Tutorial FIRST = new TutorialBuilder().withName("W03").withModule("CS2101")
            .withVenue("ST17").withTimeslot("9:00-11:00").build();
