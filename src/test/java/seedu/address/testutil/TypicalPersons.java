...
public class TypicalPersons {
    ...
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            ...
            .withNetWorth("$7777").withFilePath("src/test/data/TestPDFs/Test_PDF4.pdf").build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withFilePath(EMPTY_FILEPATH).withTags(VALID_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withNetWorth("$53000")
            .withFilePath(EMPTY_FILEPATH).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
