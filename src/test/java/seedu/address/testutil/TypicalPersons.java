...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253").withRemark("").withNetWorth("$54400")
            .withFilePath("src/main/resources/misc/Test_PDF.pdf").withTags("friends").build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withFilePath(VALID_FILEPATH_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withNetWorth("$53000")
            .withFilePath(VALID_FILEPATH_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
