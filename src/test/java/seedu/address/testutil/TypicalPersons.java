...
public class TypicalPersons {
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            ...
            .withMeetingTimes("30-12-2023-10:00")
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            ...
            .withMeetingTimes("06-10-2023-18:00")
    ...
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            ...
            .withMeetingTimes("19-11-2024-02:00").withFilePath("src/test/data/TestPDFs/Test_PDF6.pdf").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withAddress("4th street").withNetWorth("$1000")
            .withMeetingTimes("15-06-2022-17:00").withFilePath("src/test/data/TestPDFs/Test_PDF7.pdf").build();
    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAddress("little india").withNetWorth("$2990")
            .withMeetingTimes("28-07-2020-15:00").withFilePath("src/test/data/TestPDFs/Test_PDF6.pdf").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withEmail("hans@example.com").withAddress("chicago ave").withNetWorth("$399999")
            .withMeetingTimes("14-03-2023-16:00").withFilePath("src/test/data/TestPDFs/Test_PDF7.pdf").build();
    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withNetWorth("$1350")
            .withMeetingTimes(VALID_MEETING_TIME_AMY).withFilePath(EMPTY_FILEPATH).withTags(VALID_TAG_FRIEND).build();
