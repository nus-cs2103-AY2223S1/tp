...
public class TypicalPersons {
    ...
    public static final Student DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            ...
            .build();
    public static final Student ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("94822241")
    ...
    public static final Student GEORGE = new PersonBuilder().withName("George Best").withPhone("94824421")
            .withNokPhone("68337890").withEmail("anna@example.com").withAddress("4th street").build();

    public static final Student AVA = new PersonBuilder().withName("Ava Tan").withPhone("93217654")
            .withNokPhone("95552332").withEmail("ava@example.com").withAddress("computing drive")
            .withMoneyPaid(100).withMoneyOwed(30).build();

    public static final Student BEN = new PersonBuilder().withName("Ben Leong").withPhone("92226666")
    ...
    public static final Student IDA = new PersonBuilder().withName("Ida Mueller").withPhone("84821311")
