...
public class TypicalPersons {
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            ...
            .withGroups(new String[]{"Team Project"}).build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street").withTags("friends").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave")
            .withAssignments(new String[]{"Alpha", "Beta"}, new String[][]{{"Team Project"}, {"Team Beta"}}).build();
    ...
    public static final Person ALILI = new PersonBuilder().withName("Alili Pauline")
            .withAddress("123, Jurong West Ave 6, #08-111").withEmail("alice@example.com")
            .withPhone("94351253")
            .withTags("friends")
            .withAssignments(new String[]{"Group 1"}, new String[][]{{"Midterms"}}).build();
