...
class AssignTaskCommandTest {
    ...
    public void execute_invalidTaskIndexUnfilteredList_throwsCommandException() {
        ...
        assertCommandFailure(assignTaskCommand, model, String.format(MESSAGE_TASK_INDEX_OUT_OF_BOUNDS, outOfBoundTaskIndex + 1));
    }
    ...
    public void execute_invalidMemberIndexUnfilteredList_throwsCommandException() {
        ...
        assertCommandFailure(assignTaskCommand, model, String.format(MESSAGE_TASK_INDEX_OUT_OF_BOUNDS, outOfBoundMemberIndex + 1));
    }
