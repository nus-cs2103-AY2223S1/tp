...
public class CommandTestUtil {
    ...
    public static final String VALID_BIRTHDATE_AMY = "1981-11-12";
    public static final String VALID_BIRTHDATE_BOB = "2001-01-01";
    public static final String VALID_RACE_AMY = "Chinese";
    public static final String VALID_RACE_BOB = "Malay";
    public static final String VALID_RELIGION_AMY = "Christian";
    public static final String VALID_RELIGION_BOB = "Muslim";
    public static final String VALID_SURVEY_AMY = "Environment Survey";
    public static final String VALID_SURVEY_BOB = "Shopping Survey";
    ...
    public static final String SURVEY_DESC_AMY = " " + PREFIX_SURVEY + VALID_SURVEY_AMY;
    public static final String SURVEY_DESC_BOB = " " + PREFIX_SURVEY + VALID_SURVEY_BOB;
