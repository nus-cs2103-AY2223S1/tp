...
public class CommandTestUtil {
    ...
    public static final String INVALID_UNIVERSITY_DESC = " " + PREFIX_UNIVERSITY + "St@r"; // '@' not allowed for universities
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withUniversity(VALID_UNIVERSITY_AMY).withTags(VALID_TAG_FRIEND).build();
