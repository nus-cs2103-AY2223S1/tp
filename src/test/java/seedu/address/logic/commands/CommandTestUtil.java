...
public class CommandTestUtil {
    ...
    public static final String DESIRED_CHARACTERISTICS_DESC_AMY = " " + PREFIX_CHARACTERISTICS + VALID_DESIRED_CHARACTERISTICS_AMY;
    public static final String DESIRED_CHARACTERISTICS_DESC_BOB = " " + PREFIX_CHARACTERISTICS + VALID_DESIRED_CHARACTERISTICS_BOB;
    ...
    public static final String INVALID_DESIRED_CHARACTERISTICS_DESC = " " + PREFIX_CHARACTERISTICS; // empty string not allowed for desired characteristics
