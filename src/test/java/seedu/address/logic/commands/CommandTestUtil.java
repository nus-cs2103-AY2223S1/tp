...
public class CommandTestUtil {
    ...
    public static final String VALID_TUTORIAL_AMY = "T08";
    public static final String VALID_TUTORIAL_BOB = "W09";
    ...
    public static final String INVALID_OCCUPATION_DESC = " " + PREFIX_OCCUPATION + "STU&";
    public static final String INVALID_NAME_DESC = " " + PREFIX_NAME + "James&"; // '&' not allowed in names
    public static final String INVALID_PHONE_DESC = " " + PREFIX_PHONE + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_TUTORIAL_DESC = " " + PREFIX_TUTORIAL + "A"; // 'A' not allowed in tutorial
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredPersonList(new PersonContainsKeywords(Arrays.asList(splitName[0])));
