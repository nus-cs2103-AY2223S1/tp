...
public class CommandTestUtil {
    ...
    public static final String VALID_POSITION_AMY = "TA";
    public static final String VALID_POSITION_BOB = "Professor";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_REMARK_AMY = "Like skiing.";
    public static final String VALID_REMARK_BOB = "Favourite pastime: Eating";
    public static final String VALID_TAG_HUSBAND = "CS2103-T02";
    public static final String VALID_TAG_FRIEND = "CS2103-T01";
