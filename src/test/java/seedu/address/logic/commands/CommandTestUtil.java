...
public class CommandTestUtil {
    ...
    public static final String INVALID_TAG_DESC = " " + PREFIX_TAG + " "; // empty string not allowed
    ...
    public static final String INVALID_LECTURE_ZOOM_LINK = " " + PREFIX_LECTURE_ZOOM + "zoom.com"; // needs https://
    public static final String INVALID_TUTORIAL_ZOOM_LINK = " " + PREFIX_TUTORIAL_ZOOM + "zoom.com"; // needs https://
