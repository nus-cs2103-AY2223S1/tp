...
public class CommandTestUtil {
    ...
    public static final String VALID_AGE_AMY = "88";
    ...
    public static final String INVALID_AGE_DESC = " " + PREFIX_AGE + "1234"; // 4 digits not allowed in ages
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY).withAge(VALID_AGE_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB).withAge(VALID_AGE_BOB)
