...
public class CommandTestUtil {
    ...
    public static final String VALID_GROUP_NAME = "group1";
    public static final String VALID_PATH = "group1/group2/group3";
    ...
    public static final String INVALID_GROUP_NAME = "group 1";
