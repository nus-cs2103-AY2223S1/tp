...
import static seedu.address.logic.parser.CliSyntax.PREFIX_PROJECTNAME;
...
public class CommandTestUtil {
    ...
    public static final String INVALID_PROJECTNAME_DESC = " " + PREFIX_PROJECTNAME; // empty string not allowed for projects
