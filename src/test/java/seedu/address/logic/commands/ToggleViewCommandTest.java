...
class ToggleViewCommandTest {
    ...
    public void execute_toggleHide() {
        CommandResult expectedCommandResult = new CommandResult(ToggleViewCommand.MESSAGE_SUCCESS_HIDE, false, true, false);
    ...
    public void execute_toggleHide_thenToggleShow() {
        CommandResult expectedCommandResult1 = new CommandResult(ToggleViewCommand.MESSAGE_SUCCESS_HIDE, false, true, false);
        CommandResult expectedCommandResult2 = new CommandResult(ToggleViewCommand.MESSAGE_SUCCESS_SHOW, false, true, false);
