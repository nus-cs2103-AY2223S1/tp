...
class SetCommandTest {
    ...
    private final Command commandToBeTested = new SetCommand();
    ...
    public void execute_helpFlagSupplied_success() {
        ...
        CommandResult expectedResult = new CommandResult(
                SetCommand.HELP_MESSAGE + commandLine.getUsageMessage());
        assertCommandSuccess(commandToBeTested, model, expectedResult, expectedModel);
    }
    @Test
    public void execute_noSubCommand_throwsError() {
        String resultString = String.format(
                Messages.MESSAGE_INVALID_COMMAND_WITH_HELP_FORMAT, SetCommand.COMMAND_WORD);
