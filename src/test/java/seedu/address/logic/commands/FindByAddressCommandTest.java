...
/**
 * Contains integration tests (interaction with the Model) for {@code FindByAddressCommand}.
 */
public class FindByAddressCommandTest {
    ...
    public void equals() {
        ...
        FindByAddressCommand findFirstAddressCommand = new FindByAddressCommand(firstPredicate);
        FindByAddressCommand findSecondAddressCommand = new FindByAddressCommand(secondPredicate);
