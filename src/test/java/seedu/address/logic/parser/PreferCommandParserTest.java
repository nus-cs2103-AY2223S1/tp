...
public class PreferCommandParserTest {
    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, PreferCommand.MESSAGE_USAGE);

    private PreferCommandParser parser = new PreferCommandParser();
