...
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.ADDRESS_DESC_AMY;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.ADDRESS_DESC_BOB;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.DESIRED_CHARACTERISTICS_DESC_AMY;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.DESIRED_CHARACTERISTICS_DESC_BOB;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.EMAIL_DESC_AMY;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.EMAIL_DESC_BOB;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.INVALID_ADDRESS_DESC;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.INVALID_EMAIL_DESC;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.INVALID_NAME_DESC;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.INVALID_PHONE_DESC;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.INVALID_PRICE_RANGE_DESC;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.INVALID_PRIORITY_DESC;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.NAME_DESC_AMY;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.NAME_DESC_BOB;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.PHONE_DESC_AMY;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.PHONE_DESC_BOB;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.PREAMBLE_NON_EMPTY;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.PREAMBLE_WHITESPACE;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.PRICE_RANGE_DESC_AMY;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.PRICE_RANGE_DESC_BOB;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.TAG_DESC_PRIORITY_HIGH;
import static seedu.address.logic.commands.buyer.BuyerCommandTestUtil.TAG_DESC_PRIORITY_LOW;
