...
public class ParserUtilTest {
    ...
    private static final String INVALID_FILEPATH = "src/main/resources/misc/Test_PDF.p";
    ...
    private static final String VALID_FILEPATH = "src/main/resources/misc/Test_PDF4.pdf";
