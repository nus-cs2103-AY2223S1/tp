...
import static seedu.address.logic.parser.ParserUtil.MESSAGE_INDEX_TOO_LONG;
...
public class ParserUtilTest {
    ...
    private static final String INVALID_DATETIME = "2020/02/02 ABCD";

    private static final String VALID_TITLE = "Discuss presentation";
    private static final String VALID_DATETIME = "2020/02/02 12:00";
    ...
    public void parseIndex_outOfRangeInput_throwsParseException() {
        assertThrows(ParseException.class, MESSAGE_INDEX_TOO_LONG, ()
    ...
    public void parseIndex_validInput_success() throws Exception {
        // No whitespaces
        assertEquals(INDEX_FIRST_PROFILE, ParserUtil.parseIndex("1"));
