...
import static seedu.address.logic.commands.CommandTestUtil.STUDENT_DESC_TEACHING_INFO;
...
public class EditStuCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_ID_DESC, StudentId.MESSAGE_CONSTRAINTS); // invalid Id
        assertParseFailure(parser, "1" + INVALID_TELEGRAM_DESC, TelegramHandle.MESSAGE_CONSTRAINTS); // invalid
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                ...
                + ID_DESC_AMY + TELEGRAM_DESC_BOB + STUDENT_DESC_STUDENT_INFO
                + STUDENT_DESC_TEACHING_INFO;
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // id
        userInput = targetIndex.getOneBased() + ID_DESC_BOB;
        descriptor = new EditStudentDescriptorBuilder().withStudentId(VALID_ID_BOB).build();
        expectedCommand = new EditStuCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // telegram
        userInput = targetIndex.getOneBased() + TELEGRAM_DESC_BOB;
        descriptor = new EditStudentDescriptorBuilder().withTelegramHandle(VALID_TELEGRAM_BOB).build();
        expectedCommand = new EditStuCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // module info
        userInput = targetIndex.getOneBased() + STUDENT_DESC_STUDENT_INFO;
        descriptor = new EditStudentDescriptorBuilder().withStudentModuleInfo(VALID_INFO_AMY).build();
        expectedCommand = new EditStuCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
