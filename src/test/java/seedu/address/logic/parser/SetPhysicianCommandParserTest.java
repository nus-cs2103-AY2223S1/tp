...
class SetPhysicianCommandParserTest {

    @Test
    void parse_noArgumentsSupplied_displaysHelp() {
        assertParseFailure(new SetPhysicianCommandParser(), SetPhysicianCommand.COMMAND_WORD,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, SetPhysicianCommand.MESSAGE_USAGE));
    }

    @Test
    void parse_noUidSupplied_displaysHelp() {
        String input = SetPhysicianCommand.COMMAND_WORD + " n/J e/jd@example.com p/81234567";
    ...
    void parse_assignJohnDoeToPatient_success() {
        ...
        String input = SetPhysicianCommand.COMMAND_WORD + " id/3 n/" + DEFAULT_PHYS_NAME + " e/" + DEFAULT_PHYS_EMAIL
