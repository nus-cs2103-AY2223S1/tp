...
public class SellCommandParserTest {
    ...
    private final Transaction nonEmptyTransaction = new SellTransaction(goods, price, quantity);
    ...
    public void parse_indexSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + " " + PREFIX_QUANTITY + nonEmptyQuantity + PREFIX_GOODS + nonEmptyGood + PREFIX_PRICE +
                nonEmptyPrice;
        SellCommand expectedCommand = new SellCommand(INDEX_FIRST_COMPANY, nonEmptyTransaction);
