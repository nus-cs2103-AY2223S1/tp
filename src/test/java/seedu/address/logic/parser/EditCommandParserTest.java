...
import static seedu.address.logic.commands.CommandTestUtil.TAG_DESC_EXAM_1;
import static seedu.address.logic.commands.CommandTestUtil.TAG_DESC_EXAM_2;
import static seedu.address.logic.commands.CommandTestUtil.VALID_CLASS_AMY;
import static seedu.address.logic.commands.CommandTestUtil.VALID_EMAIL_AMY;
import static seedu.address.logic.commands.CommandTestUtil.VALID_EMAIL_BOB;
import static seedu.address.logic.commands.CommandTestUtil.VALID_EXAM_1;
import static seedu.address.logic.commands.CommandTestUtil.VALID_EXAM_2;
...
public class EditCommandParserTest {
    ...
    public void parse_resetTags_success() {
        Index targetIndex = INDEX_THIRD_PERSON;
        String userInput = targetIndex.getOneBased() + EXAM_EMPTY;
