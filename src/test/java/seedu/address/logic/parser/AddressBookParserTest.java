...
public class AddressBookParserTest {
    ...
    public void parseCommand_list() throws Exception {
        assertTrue(parser.parseCommand(ViewPersonListCommand.COMMAND_WORD) instanceof ViewPersonListCommand);
        assertTrue(parser.parseCommand(ViewPersonListCommand.COMMAND_WORD + " 3") instanceof ViewPersonListCommand);
    }
