...
public class RemoveCommandParserTest {
    ...
    public void parse_validUserWithValidLesson_success() {
        RemoveCommand expectedCommand = new RemoveUserCommand(new LessonBuilder().build());
    ...
    public void parse_validIndexWithValidLesson_success() {
        ...
        RemoveCommand expectedCommand = new RemoveIndexCommand(new LessonBuilder().build(), index);
