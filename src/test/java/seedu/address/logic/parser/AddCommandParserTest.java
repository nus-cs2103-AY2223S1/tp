...
import static seedu.address.logic.commands.CommandTestUtil.MEETING_LOCATION_DESC_BOB;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).withPlans(VALID_PLANS_BOB).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + INCOME_DESC_BOB + MEETING_DATE_DESC_BOB + MEETING_LOCATION_DESC_BOB
                + TAG_DESC_FRIEND + RISK_DESC_BOB + PLAN_DESC_BOB + NOTE_DESC_BOB,
            new AddCommand(expectedPerson));

        // multiple names - last name accepted
        assertParseSuccess(parser, NAME_DESC_AMY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + INCOME_DESC_BOB + MEETING_DATE_DESC_BOB + TAG_DESC_FRIEND + RISK_DESC_BOB
                + PLAN_DESC_BOB + NOTE_DESC_BOB + MEETING_LOCATION_DESC_BOB,
            new AddCommand(expectedPerson));

        // multiple phones - last phone accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_AMY + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + INCOME_DESC_BOB + MEETING_DATE_DESC_BOB + TAG_DESC_FRIEND + RISK_DESC_BOB
                + MEETING_LOCATION_DESC_BOB + PLAN_DESC_BOB + NOTE_DESC_BOB,
            new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INCOME_DESC_BOB + TAG_DESC_HUSBAND + MEETING_DATE_DESC_BOB + TAG_DESC_FRIEND + RISK_DESC_BOB
                + MEETING_LOCATION_DESC_BOB + PLAN_DESC_BOB + NOTE_DESC_BOB,
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Person expectedPerson = new PersonBuilder(AMY).withTags().withPlans(VALID_PLANS_AMY).build();
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
            + INCOME_DESC_AMY + MEETING_DATE_DESC_AMY + MEETING_LOCATION_DESC_AMY + RISK_DESC_AMY
            + PLAN_DESC_AMY + NOTE_DESC_AMY, new AddCommand(expectedPerson));
    }
