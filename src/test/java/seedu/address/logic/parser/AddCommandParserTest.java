...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).withUniversalUid().build();
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero dateTimes
        Person expectedPersonNoDatesTimes = new PersonBuilder(AMY).withUniversalUid().withDatesTimes().build();

        assertParseSuccess(parser, CATEGORY_DESC_PATIENT + NAME_DESC_AMY + GENDER_DESC_AMY
                + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + TAG_DESC_FRIEND,
                new AddCommand(expectedPersonNoDatesTimes));
        // zero tags
        Person expectedPersonNoTag = new PersonBuilder(AMY).withUniversalUid().withTags().build();
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_PATIENT_CATEGORY + NAME_DESC_BOB + GENDER_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);

        // missing name prefix
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + VALID_NAME_BOB + GENDER_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);

        // missing gender prefix
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + VALID_GENDER_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB
        ...
        assertParseFailure(parser, VALID_PATIENT_CATEGORY + VALID_NAME_BOB + VALID_GENDER_BOB
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid gender
        assertParseFailure(parser, CATEGORY_DESC_PATIENT + NAME_DESC_BOB + INVALID_GENDER_DESC
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATETIME_DESC_BOB + TAG_DESC_HUSBAND
        ...
        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + CATEGORY_DESC_PATIENT + NAME_DESC_BOB
