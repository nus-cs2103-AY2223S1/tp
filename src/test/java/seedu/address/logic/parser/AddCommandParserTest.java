...
import static seedu.address.logic.commands.CommandTestUtil.VALID_ENTITY_STUDENT;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedStudent = new StudentBuilder(BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        //todo: test tutor and class and add more test for the new fields
    }
