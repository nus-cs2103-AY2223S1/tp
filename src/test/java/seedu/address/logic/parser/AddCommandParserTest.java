...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Client expectedClient = new CompanyBuilder(BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        Client expectedClientMultipleTags = new CompanyBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
