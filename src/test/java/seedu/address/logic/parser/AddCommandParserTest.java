...
import static seedu.address.logic.commands.CommandTestUtil.INVALID_DATESLOT_DESC;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        Person expectedPersonMultipleDatesTimes = new PersonBuilder(BOB).withUniversalUid().withTags(VALID_TAG_FRIEND)
                .withDatesSlots(VALID_DATESLOT_BOB, VALID_DATESLOT_AMY).build();
        assertParseSuccess(parser, CATEGORY_DESC_BOB + NAME_DESC_BOB + GENDER_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATESLOT_DESC_AMY + DATESLOT_DESC_BOB
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withUniversalUid()
                ...
                .build();
        assertParseSuccess(parser, CATEGORY_DESC_BOB + NAME_DESC_BOB + GENDER_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATESLOT_DESC_BOB + TAG_DESC_FRIEND
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_CATEGORY_DESC + NAME_DESC_BOB + GENDER_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATESLOT_DESC_BOB + TAG_DESC_HUSBAND
        ...
        // invalid phone
        assertParseFailure(parser, CATEGORY_DESC_BOB + NAME_DESC_BOB + GENDER_DESC_BOB
                + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATESLOT_DESC_BOB + TAG_DESC_HUSBAND
                + TAG_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, CATEGORY_DESC_BOB + NAME_DESC_BOB + GENDER_DESC_BOB
                + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB + DATESLOT_DESC_BOB + TAG_DESC_HUSBAND
                + TAG_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, CATEGORY_DESC_BOB + NAME_DESC_BOB + GENDER_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC + DATESLOT_DESC_BOB + TAG_DESC_HUSBAND
                + TAG_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);

        // invalid datesSlots
        assertParseFailure(parser, CATEGORY_DESC_BOB + NAME_DESC_BOB + GENDER_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + INVALID_DATESLOT_DESC + TAG_DESC_HUSBAND
                + TAG_DESC_FRIEND, DateSlot.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, CATEGORY_DESC_BOB + NAME_DESC_BOB + GENDER_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATESLOT_DESC_BOB + INVALID_TAG_DESC
