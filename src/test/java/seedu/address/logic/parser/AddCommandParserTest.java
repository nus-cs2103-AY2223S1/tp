...
public class AddCommandParserTest {
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, UID_DESC_AMY + CATEGORY_DESC_PATIENT + NAME_DESC_AMY + GENDER_DESC_AMY
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing uid prefix
        assertParseFailure(parser, VALID_UID_BOB + NAME_DESC_BOB + GENDER_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);
        // missing category prefix
        assertParseFailure(parser, UID_DESC_BOB + VALID_PATIENT_CATEGORY + NAME_DESC_BOB + GENDER_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);

        // missing name prefix
        assertParseFailure(parser, UID_DESC_BOB + CATEGORY_DESC_PATIENT + VALID_NAME_BOB + GENDER_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);

        // missing gender prefix
        assertParseFailure(parser, UID_DESC_BOB + CATEGORY_DESC_PATIENT + NAME_DESC_BOB + VALID_GENDER_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, UID_DESC_BOB + CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB
        ...
        assertParseFailure(parser, VALID_UID_BOB + VALID_PATIENT_CATEGORY + VALID_NAME_BOB + VALID_GENDER_BOB
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid id
        assertParseFailure(parser, INVALID_UID_DESC + CATEGORY_DESC_PATIENT + NAME_DESC_BOB + GENDER_DESC_BOB
        ...
        assertParseFailure(parser, UID_DESC_BOB + INVALID_CATEGORY_DESC + NAME_DESC_BOB + GENDER_DESC_BOB
                        ...
                        + TAG_DESC_FRIEND, "Category can only be P or N. P for patient, N for nurse.");
        ...
        // invalid gender
        assertParseFailure(parser, UID_DESC_BOB + CATEGORY_DESC_PATIENT + NAME_DESC_BOB + INVALID_GENDER_DESC
                        + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DATETIME_DESC_BOB + TAG_DESC_HUSBAND
        ...
        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + UID_DESC_BOB + CATEGORY_DESC_PATIENT + NAME_DESC_BOB
