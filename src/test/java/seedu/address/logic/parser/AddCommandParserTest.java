...
public class AddCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + INVALID_PHONE_DESC + EMAIL_DESC_BOB + POSITION_DESC_BOB
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + POSITION_DESC_BOB
                + INVALID_ADDRESS_DESC + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);
