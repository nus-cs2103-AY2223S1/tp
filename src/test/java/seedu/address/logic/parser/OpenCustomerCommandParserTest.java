...
public class OpenCustomerCommandParserTest {
    ...
    public void parse_validArgs_returnsOpenCustomerCommand() {
        assertParseSuccess(parser, "1", new OpenCustomerCommand(INDEX_FIRST_CUSTOMER));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a", String.format(MESSAGE_INVALID_COMMAND_FORMAT, OpenCustomerCommand.MESSAGE_USAGE));
    }
}
