...
public class EditExamCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_EXAM_DESCRIPTION,
                ExamDescription.DESCRIPTION_CONSTRAINTS); // invalid phone
        ...
        //two fields
        assertParseFailure(parser, "1" + INVALID_MODULE
                + EXAMDESCRIPTIONONE, ModuleCode.MODULE_CODE_CONSTRAINTS);
        assertParseFailure(parser, "1" + EXAMDESCRIPTIONONE
                + INVALID_FORMAT_EXAM_DATESEVEN, ExamDate.DATE_FORMAT_CONSTRAINTS);
        ...
        assertParseFailure(parser, "1" + INVALID_EXAM_DESCRIPTION
                + EXAMMODULEONE + EXAMDATEONE, ExamDescription.DESCRIPTION_CONSTRAINTS);

        //invalid date followed by valid module  and description
        assertParseFailure(parser, "1" + INVALID_FORMAT_EXAM_DATESEVEN
                + EXAMMODULEONE + EXAMDESCRIPTIONONE, ExamDate.DATE_FORMAT_CONSTRAINTS);
        // valid description and date followed by invalid module.
        assertParseFailure(parser, "1" + EXAMDESCRIPTIONONE
                + EXAMDATEONE + INVALID_MODULE, ModuleCode.MODULE_CODE_CONSTRAINTS);
        //valid module and date followed by invalid description
        assertParseFailure(parser, "1" + EXAMMODULEONE
                + EXAMDATEONE + INVALID_EXAM_DESCRIPTION , ExamDescription.DESCRIPTION_CONSTRAINTS);
        //valid module and description followed by invalid date
        assertParseFailure(parser, "1" + EXAMMODULEONE
                + EXAMDESCRIPTIONONE + INVALID_FORMAT_EXAM_DATESEVEN, ExamDate.DATE_FORMAT_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        Index targetIndex = INDEX_SECOND_EXAM;
        ...
        EditExamCommand.EditExamDescriptor descriptor =
                new EditExamDescriptorBuilder().withDescription(VALID_DESCRIPTION_EXAMONE)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditExamCommand.EditExamDescriptor descriptor = new EditExamDescriptorBuilder()
                .withDescription(VALID_DESCRIPTION_EXAMONE)
    ...
    public void parse_someFieldsSpecifiedTestTwo_success() {
        ...
        EditExamCommand.EditExamDescriptor descriptor =
                new EditExamDescriptorBuilder().withModule(VALID_MODULE_EXAMONE)
                .withDate(VALID_DATE_EXAMONE).build();
        EditExamCommand expectedCommand = new EditExamCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        Index targetIndex = INDEX_FIRST_EXAM;
        String userInput = targetIndex.getOneBased()
                + INVALID_EXAM_DATETWO + EXAMDATETWO;
        EditExamCommand.EditExamDescriptor descriptor =
                new EditExamDescriptorBuilder().withDate(VALID_DATE_EXAMTWO).build();
        EditExamCommand expectedCommand = new EditExamCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // other valid values specified
        userInput = targetIndex.getOneBased() + EXAMDATEONE
                + INVALID_EXAM_DESCRIPTION + EXAMMODULETWO
                + EXAMDESCRIPTIONTWO;
