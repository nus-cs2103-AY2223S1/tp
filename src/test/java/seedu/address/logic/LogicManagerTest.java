...
public class LogicManagerTest {
    ...
    public void setUp() {
        ...
        SimpleImageStorage imageStorage = new SimpleImageStorage(temporaryFolder.resolve(""));
        StorageManager storage = new StorageManager(addressBookStorage, userPrefsStorage, imageStorage);
