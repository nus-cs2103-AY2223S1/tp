...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonJeeqTrackerStorage jeeqTrackerStorage =
                new JsonJeeqTrackerStorage(temporaryFolder.resolve("jeeqTracker.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(jeeqTrackerStorage, userPrefsStorage);
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonJeeqTrackerIoExceptionThrowingStub
        JsonJeeqTrackerStorage jeeqTrackerStorage =
                new JsonJeeqTrackerIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionJeeqTracker.json"));
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY
                + ADDRESS_DESC_AMY;
        Client expectedClient = new CompanyBuilder(AMY).withTags().build();
        ModelManager expectedModel = new ModelManager();
        expectedModel.addCompany(expectedClient);
     ...
     */
    private static class JsonJeeqTrackerIoExceptionThrowingStub extends JsonJeeqTrackerStorage {
        private JsonJeeqTrackerIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
