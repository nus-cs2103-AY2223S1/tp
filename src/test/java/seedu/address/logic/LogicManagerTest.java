...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonTeachersPetStorage teachersPetStorage =
                new JsonTeachersPetStorage(temporaryFolder.resolve("teachersPet.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(teachersPetStorage, userPrefsStorage);
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonTeachersPetIoExceptionThrowingStub
        JsonTeachersPetStorage teachersPetStorage =
                new JsonTeachersPetIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionTeachersPet.json"));
        ...
        // Execute add command
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + NOK_PHONE_DESC_AMY
     ...
     */
    private static class JsonTeachersPetIoExceptionThrowingStub extends JsonTeachersPetStorage {
        private JsonTeachersPetIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
