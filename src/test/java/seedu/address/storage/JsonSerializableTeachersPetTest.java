...
public class JsonSerializableTeachersPetTest {
    ...
    private static final Path TYPICAL_PERSONS_FILE = TEST_DATA_FOLDER.resolve("typicalPersonsTeachersPet.json");
    private static final Path INVALID_PERSON_FILE = TEST_DATA_FOLDER.resolve("invalidPersonTeachersPet.json");
    ...
    public void toModelType_typicalPersonsFile_success() throws Exception {
        ...
        TeachersPet typicalPersonsTeachersPet = TypicalPersons.getTypicalTeachersPet();
