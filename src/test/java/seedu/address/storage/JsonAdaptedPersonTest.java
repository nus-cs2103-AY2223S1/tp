...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_GENDER = "random";
    private static final String INVALID_BIRTHDATE = "12-12-1999";
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_GENDER, VALID_BIRTHDATE, VALID_RACE, VALID_RELIGION, VALID_SURVEY, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_GENDER, VALID_BIRTHDATE, VALID_RACE, VALID_RELIGION, VALID_SURVEY, invalidTags);
    ...
    public void toModelType_invalidGender_throwsIllegalValueException() {
        ...
        invalidTags.add(new JsonAdaptedTag(INVALID_TAG));
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                INVALID_GENDER, VALID_BIRTHDATE, VALID_RACE, VALID_RELIGION, VALID_SURVEY, VALID_TAGS);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
    ...
    public void toModelType_invalidBirthdate_throwsIllegalValueException() {
        ...
        invalidTags.add(new JsonAdaptedTag(INVALID_TAG));
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_GENDER, INVALID_BIRTHDATE, VALID_RACE, VALID_RELIGION, VALID_SURVEY, VALID_TAGS);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
}
