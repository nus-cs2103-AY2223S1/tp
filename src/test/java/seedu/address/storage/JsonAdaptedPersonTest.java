...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_REMARK, VALID_NETWORTH, VALID_MEETING_TIMES, VALID_FILEPATH, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, null, VALID_EMAIL,
                VALID_ADDRESS, VALID_REMARK, VALID_NETWORTH, VALID_MEETING_TIMES, VALID_FILEPATH, VALID_TAGS);
    ...
    public void toModelType_invalidNetWorth_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_REMARK, INVALID_NETWORTH, VALID_MEETING_TIMES, VALID_FILEPATH, VALID_TAGS);
    ...
    public void toModelType_nullNetWorth_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_REMARK, null, VALID_MEETING_TIMES, VALID_FILEPATH, VALID_TAGS);
    ...
    public void toModelType_invalidMeetingTime_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_REMARK, VALID_NETWORTH, invalidMeetingTimes, VALID_FILEPATH, VALID_TAGS);
    ...
    public void toModelType_invalidFilePath_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_REMARK, VALID_NETWORTH, VALID_MEETING_TIMES, INVALID_FILEPATH, VALID_TAGS);
    ...
    public void toModelType_nullFilePath_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_REMARK, VALID_NETWORTH, VALID_MEETING_TIMES, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_REMARK, VALID_NETWORTH, VALID_MEETING_TIMES, VALID_FILEPATH, invalidTags);
