...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidOccupation_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_OCCUPATION, VALID_NAME,
                        VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, VALID_SOCIAL, VALID_GROUPS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                        INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, VALID_SOCIAL, VALID_GROUPS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                null, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, VALID_SOCIAL, VALID_GROUPS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                        VALID_PHONE, INVALID_EMAIL, VALID_ADDRESS, VALID_TAGS, VALID_SOCIAL, VALID_GROUPS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                VALID_PHONE, null, VALID_ADDRESS, VALID_TAGS, VALID_SOCIAL, VALID_GROUPS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                        VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS, VALID_TAGS, VALID_SOCIAL, VALID_GROUPS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                VALID_PHONE, VALID_EMAIL, null, VALID_TAGS, VALID_SOCIAL, VALID_GROUPS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                        VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, invalidTags, VALID_SOCIAL, VALID_GROUPS);
