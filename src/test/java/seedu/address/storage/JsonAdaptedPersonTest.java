...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, null,
                VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TUTORIAL, VALID_TAGS, VALID_SOCIAL);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                null, VALID_EMAIL, VALID_TUTORIAL, VALID_ADDRESS, VALID_TAGS, VALID_SOCIAL);
    ...
    public void toModelType_nullTutorial_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                VALID_PHONE, VALID_EMAIL, null, VALID_ADDRESS, VALID_TAGS, VALID_SOCIAL);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, Email.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                VALID_PHONE, VALID_EMAIL, VALID_TUTORIAL, null, VALID_TAGS, VALID_SOCIAL);
