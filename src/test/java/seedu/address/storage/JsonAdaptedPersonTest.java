...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_MINECRAFT_NAME = BENSON.getMinecraftName().toString();
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_MINECRAFT_NAME,
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_MINECRAFT_NAME,
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_MINECRAFT_NAME, VALID_PHONE,
    ...
    public void toModelType_invalidMinecraftName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, INVALID_MINECRAFTNAME, VALID_PHONE,
                        VALID_EMAIL, INVALID_ADDRESS, VALID_SOCIALS,
                        VALID_TAGS, VALID_SERVERS, VALID_COUNTRY, VALID_GAME_TYPE, VALID_TIME_INTERVAL);
        String expectedMessage = Address.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    ...
    @Test
    public void toModelType_invalidSocials_throwsIllegalValueException() {
        List<JsonAdaptedSocial> invalidSocials = new ArrayList<>(VALID_SOCIALS);
        invalidSocials.add(new JsonAdaptedSocial(INVALID_SOCIAL));
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_MINECRAFT_NAME, VALID_PHONE,
                        VALID_EMAIL, VALID_ADDRESS, invalidSocials,
                        VALID_TAGS, VALID_SERVERS, VALID_COUNTRY, VALID_GAME_TYPE, VALID_TIME_INTERVAL);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
