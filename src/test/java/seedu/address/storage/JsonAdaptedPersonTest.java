...
public class JsonAdaptedPersonTest {
    ...
    private static final List<JsonAdaptedGradeProgress> VALID_GRADE_PREOGRESS = BENSON.getGradeProgressList()
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_LESSON_PLAN,
                        VALID_HOMEWORK, VALID_GRADE_PREOGRESS, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_LESSON_PLAN,
                        VALID_HOMEWORK, VALID_GRADE_PREOGRESS, invalidTags);
