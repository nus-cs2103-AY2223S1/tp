...
public class JsonAdaptedPersonTest {
    ...
    private static final Integer INVALID_MONEY_PER_CLASS = -100;
    ...
    private static final Integer VALID_MONEY_PER_CLASS = BENSON.getMoneyPerClass().value;
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                ...
                VALID_MONEY_PER_CLASS, VALID_ADDITIONAL_NOTES);
    ...
    @Test
    public void toModelType_invalidMoneyPerClass_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_CLASS_DATE_TIME, VALID_MONEY_OWED, VALID_MONEY_PAID,
                INVALID_MONEY_PER_CLASS, VALID_ADDITIONAL_NOTES);
        String expectedMessage = Money.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
}
