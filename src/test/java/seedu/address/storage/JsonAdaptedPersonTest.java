...
public class JsonAdaptedPersonTest {
    ...
    private static final List<JsonAdaptedInterest> VALID_TAGS = BENSON.getInterests().stream()
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_TELEGRAM,
                        VALID_GITHUB, VALID_TAGS, VALID_MODS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL,
            VALID_TELEGRAM, VALID_GITHUB, VALID_TAGS, VALID_MODS);
    ...
    public void toModelType_invalidHandle_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        INVALID_TELEGRAM, VALID_GITHUB, VALID_TAGS, VALID_MODS);
    ...
    public void toModelType_invalidUsername_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_TELEGRAM, INVALID_GITHUB, VALID_TAGS, VALID_MODS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        List<JsonAdaptedInterest> invalidTags = new ArrayList<>(VALID_TAGS);
        invalidTags.add(new JsonAdaptedInterest(INVALID_TAG));
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_TELEGRAM, VALID_GITHUB, invalidTags, VALID_MODS);
