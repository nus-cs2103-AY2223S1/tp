...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidOccupation_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_OCCUPATION, VALID_NAME,
                        VALID_PHONE, VALID_EMAIL, VALID_TUTORIAL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, null,
                VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TUTORIAL, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                        INVALID_PHONE, VALID_EMAIL, VALID_TUTORIAL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                null, VALID_EMAIL, VALID_TUTORIAL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                        VALID_PHONE, INVALID_EMAIL, VALID_TUTORIAL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                VALID_PHONE, null, VALID_TUTORIAL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidTutorial_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                        VALID_PHONE, INVALID_EMAIL, INVALID_TUTORIAL, VALID_ADDRESS, VALID_TAGS);
        String expectedMessage = Email.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_nullTutorial_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                VALID_PHONE, VALID_EMAIL, null, VALID_ADDRESS, VALID_TAGS);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, Email.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                        VALID_PHONE, VALID_EMAIL, VALID_TUTORIAL, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                VALID_PHONE, VALID_EMAIL, VALID_TUTORIAL, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_OCCUPATION, VALID_NAME,
                        VALID_PHONE, VALID_EMAIL, VALID_TUTORIAL, VALID_ADDRESS, invalidTags);
