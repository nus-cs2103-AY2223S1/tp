...
public class JsonAdaptedPersonTest {
    ...
    private static final List<JsonAdaptedPlan> VALID_PLAN = portfolio.getPlans().stream()
            ...
            .collect(Collectors.toList());
    private static final String VALID_NOTE = portfolio.getNote().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                ...
                VALID_RISK, VALID_PLAN, VALID_NOTE);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_INCOME, VALID_MEETING_DATE, invalidTags,
                VALID_RISK, VALID_PLAN, VALID_NOTE);
