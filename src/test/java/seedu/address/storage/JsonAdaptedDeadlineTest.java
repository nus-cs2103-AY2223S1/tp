...
public class JsonAdaptedDeadlineTest {
    ...
    public void toModelType_invalidTitle_throwsIllegalValueException() {
        JsonAdaptedDeadline deadline = new JsonAdaptedDeadline(INVALID_TASK_TITLE, VALID_TASK_DESCRIPTION, VALID_FORMAT_DATE);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedDeadline deadline = new JsonAdaptedDeadline(VALID_TASK_TITLE, INVALID_TASK_DESCRIPTION, VALID_FORMAT_DATE);
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        JsonAdaptedDeadline deadline = new JsonAdaptedDeadline(VALID_TASK_TITLE, VALID_TASK_DESCRIPTION, INVALID_FORMAT_DATE);
