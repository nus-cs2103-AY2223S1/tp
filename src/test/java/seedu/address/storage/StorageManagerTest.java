...
public class StorageManagerTest {
    ...
    public void addressBookReadSave() throws Exception {
        ...
        storageManager.saveFindMyIntern(original);
        ReadOnlyFindMyIntern retrieved = storageManager.readFindMyIntern().get();
        assertEquals(original, new FindMyIntern(retrieved));
    }
