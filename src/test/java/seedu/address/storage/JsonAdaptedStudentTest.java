...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_invalidStudentName_throwsIllegalValueException() {
        JsonAdaptedStudent person =
                new JsonAdaptedStudent(INVALID_STUDENT_NAME, VALID_ID,
                        VALID_PARENT_NAME, VALID_PHONE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullStudentName_throwsIllegalValueException() {
        JsonAdaptedStudent person = new JsonAdaptedStudent(null, VALID_ID, VALID_PARENT_NAME,
    ...
    public void toModelType_invalidParentName_throwsIllegalValueException() {
        JsonAdaptedStudent person =
                new JsonAdaptedStudent(VALID_STUDENT_NAME, VALID_ID,
                        INVALID_PARENT_NAME, VALID_PHONE, VALID_ADDRESS, VALID_TAGS);
        String expectedMessage = Name.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedStudent person =
                new JsonAdaptedStudent(VALID_STUDENT_NAME, VALID_ID, VALID_PARENT_NAME,
                        INVALID_PHONE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedStudent person = new JsonAdaptedStudent(VALID_STUDENT_NAME, VALID_ID, VALID_PARENT_NAME,
    ...
    public void toModelType_invalidId_throwsIllegalValueException() {
        JsonAdaptedStudent person =
                new JsonAdaptedStudent(VALID_STUDENT_NAME, INVALID_ID, VALID_PARENT_NAME,
                        VALID_PHONE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullId_throwsIllegalValueException() {
        JsonAdaptedStudent person = new JsonAdaptedStudent(VALID_STUDENT_NAME, null, VALID_PARENT_NAME,
                VALID_PHONE, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedStudent person =
                new JsonAdaptedStudent(VALID_STUDENT_NAME, VALID_ID, VALID_PARENT_NAME,
                        VALID_PHONE, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent person =
                new JsonAdaptedStudent(VALID_STUDENT_NAME, VALID_ID, VALID_PARENT_NAME,
                        VALID_PHONE, VALID_ADDRESS, invalidTags);
