...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
            new JsonAdaptedStudent(VALID_TYPE, VALID_NAME, VALID_MODULE_CODES, VALID_PHONE,
                    VALID_EMAIL, VALID_GENDER, invalidTags, VALID_LOCATION, VALID_GITHUB_USERNAME, VALID_YEAR);
    ...
    public void toModelType_invalidModuleCodes_throwsIllegalValueException() {
        List<JsonAdaptedModuleCode> invalidModuleCodes = new ArrayList<JsonAdaptedModuleCode>(VALID_MODULE_CODES);
        invalidModuleCodes.add(new JsonAdaptedModuleCode(INVALID_MODULE_CODE));
        JsonAdaptedPerson person =
                new JsonAdaptedStudent(VALID_TYPE, VALID_NAME, invalidModuleCodes,
                        VALID_PHONE, VALID_EMAIL, VALID_GENDER, VALID_TAGS, VALID_LOCATION, VALID_GITHUB_USERNAME,
                        VALID_YEAR);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
    ...
    public void toModelType_invalidLocation_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedStudent(VALID_TYPE, VALID_NAME, VALID_MODULE_CODES, VALID_PHONE, VALID_EMAIL,
                        VALID_GENDER, VALID_TAGS, INVALID_LOCATION, VALID_GITHUB_USERNAME,
                        VALID_YEAR);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
