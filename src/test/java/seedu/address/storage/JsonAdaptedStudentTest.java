...
public class JsonAdaptedStudentTest {
    ...
    private static final String INVALID_PICTURE_PATH = "";
    ...
    private static final String VALID_PICTURE_FILE_PATH = BENSON.getPicture().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_CLASS_GROUP, VALID_STUDENTID, VALID_TAGS, VALID_ATTENDANCE, VALID_PICTURE_FILE_PATH);
    ...
    public void toModelType_nullClassGroup_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_STUDENTID, VALID_TAGS, VALID_ATTENDANCE, VALID_PICTURE_FILE_PATH);
    ...
    public void toModelType_invalidStudentId_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_CLASS_GROUP, INVALID_STUDENTID, VALID_TAGS, VALID_ATTENDANCE, VALID_PICTURE_FILE_PATH);
    ...
    public void toModelType_nullStudentId_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_CLASS_GROUP, null, VALID_TAGS, VALID_ATTENDANCE, VALID_PICTURE_FILE_PATH);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_CLASS_GROUP, VALID_STUDENTID, invalidTags, VALID_ATTENDANCE, VALID_PICTURE_FILE_PATH);
