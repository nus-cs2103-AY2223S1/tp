...
public class JsonSerializableMassLinkersTest {
    ...
    private static final Path TYPICAL_PERSONS_FILE = TEST_DATA_FOLDER.resolve("typicalPersonsMassLinkers.json");
    private static final Path INVALID_PERSON_FILE = TEST_DATA_FOLDER.resolve("invalidPersonMassLinkers.json");
    private static final Path DUPLICATE_PERSON_FILE = TEST_DATA_FOLDER.resolve("duplicatePersonMassLinkers.json");
    ...
    public void toModelType_typicalPersonsFile_success() throws Exception {
        ...
        MassLinkers typicalPersonsMassLinkers = TypicalPersons.getTypicalMassLinkers();
        assertEquals(massLinkersFromFile, typicalPersonsMassLinkers);
    }
