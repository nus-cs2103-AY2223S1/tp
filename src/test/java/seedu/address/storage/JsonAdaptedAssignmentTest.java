...
class JsonAdaptedAssignmentTest {
    ...
    public void toModelType_nullTitle_throwsIllegalValueException() {
        JsonAdaptedAssignment assignment = new JsonAdaptedAssignment(null, VALID_TASK_DESCRIPTION, VALID_ASSIGNMENT_STUDENTS_LIST);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        JsonAdaptedAssignment assignment = new JsonAdaptedAssignment(VALID_TASK_TITLE, null, VALID_ASSIGNMENT_STUDENTS_LIST);
