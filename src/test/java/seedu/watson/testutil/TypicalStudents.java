...
import static seedu.watson.logic.commands.CommandTestUtil.VALID_INDEX_NUMBER_BOB;
...
public class TypicalStudents {
    ...
    public static final Student ALICE = new StudentBuilder().withName("Alice Pauline").withIndexNumber("1")
                                                          ...
                                                          .build();
    public static final Student BENSON = new StudentBuilder().withName("Benson Meier").withIndexNumber("2")
                                                           ...
                                                           .withSubjectHandler("english: CA1:[80.0, 100.0, 0.2, 1.0], "
                                                                   ...
                                                                   + "100.0, 0.2, 1.0], CA2:[30.0, 56.0, 0.4, 2.0]")
                                                           .build();
    public static final Student CARL = new StudentBuilder().withName("Carl Kurz").withIndexNumber("3")
                                                         .withPhone("95352563")
                                                         ...
                                                         .withSubjectHandler("english: CA1:[80.0, 100.0, 0.2, 1.0], "
                                                                 ...
                                                                 + "100.0, 0.2, 1.0], CA2:[30.0, 56.0, 0.4, 2.0]")
                                                         .build();
    public static final Student DANIEL = new StudentBuilder().withName("Daniel Meier").withIndexNumber("16")
                                                           .withPhone("87652533")
                                                           ...
                                                           .withSubjectHandler("english: CA1:[80.0, 100.0, 0.2, 1.0], "
                                                                   ...
                                                                   + "100.0, 0.2, 1.0], CA2:[30.0, 56.0, 0.4, 2.0]")
                                                           .build();
    public static final Student ELLE = new StudentBuilder().withName("Elle Meyer").withIndexNumber("11")
                                                         .withPhone("9482224")
                                                         ...
                                                         .withSubjectHandler("english: CA1:[80.0, 100.0, 0.2, 1.0], "
                                                                 ...
                                                                 + "100.0, 0.2, 1.0], CA2:[30.0, 56.0, 0.4, 2.0]")
                                                         .build();
    public static final Student FIONA = new StudentBuilder().withName("Fiona Kunz").withIndexNumber("26")
                                                          .withPhone("9482427")
                                                          ...
                                                          .withSubjectHandler("english: CA1:[80.0, 100.0, 0.2, 1.0], "
                                                                  ...
                                                                  + "100.0, 0.2, 1.0], CA2:[30.0, 56.0, 0.4, 2.0]")
                                                          .build();
    public static final Student GEORGE = new StudentBuilder().withName("George Best").withIndexNumber("33")
                                                           .withPhone("9482442")
    ...
    // Manually added
    public static final Student HOON = new StudentBuilder().withName("Hoon Meier").withIndexNumber("41")
                                                         .withPhone("8482424")
                                                         .withEmail("stefan@example.com").withAddress("little india")
                                                         .build();
    public static final Student IDA = new StudentBuilder().withName("Ida Mueller").withIndexNumber("23")
                                                        .withPhone("8482131")
