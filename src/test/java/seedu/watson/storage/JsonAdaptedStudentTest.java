...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedStudent person =
            new JsonAdaptedStudent(INVALID_NAME, VALID_INDEX_NUMBER, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedStudent person = new JsonAdaptedStudent(null, VALID_INDEX_NUMBER, VALID_PHONE,
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedStudent person =
            new JsonAdaptedStudent(VALID_NAME, VALID_INDEX_NUMBER, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                                  VALID_STUDENTCLASS, VALID_ATTENDANCE, VALID_SUBJECTHANDLER,
                                  VALID_REMARKS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedStudent person = new JsonAdaptedStudent(VALID_NAME, VALID_INDEX_NUMBER, null,
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedStudent person =
            new JsonAdaptedStudent(VALID_NAME, VALID_INDEX_NUMBER, VALID_PHONE, INVALID_EMAIL, VALID_ADDRESS,
                                  VALID_STUDENTCLASS, VALID_ATTENDANCE, VALID_SUBJECTHANDLER,
                                  VALID_REMARKS, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedStudent person = new JsonAdaptedStudent(VALID_NAME, VALID_INDEX_NUMBER, VALID_PHONE,
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedStudent person =
            new JsonAdaptedStudent(VALID_NAME, VALID_INDEX_NUMBER, VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS,
                                  VALID_STUDENTCLASS, VALID_ATTENDANCE, VALID_SUBJECTHANDLER,
                                  VALID_REMARKS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedStudent person = new JsonAdaptedStudent(VALID_NAME, VALID_INDEX_NUMBER, VALID_PHONE, VALID_EMAIL,
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent person =
            new JsonAdaptedStudent(VALID_NAME, VALID_INDEX_NUMBER, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                                  VALID_STUDENTCLASS, VALID_ATTENDANCE, VALID_SUBJECTHANDLER,
