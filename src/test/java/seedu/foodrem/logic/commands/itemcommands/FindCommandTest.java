...
import static seedu.foodrem.commons.core.Messages.MESSAGE_ITEMS_SORTED_OVERVIEW;
...
public class FindCommandTest {
    ...
    public void execute_zeroKeywords_noItemsFound() {
        String expectedMessage = String.format(MESSAGE_ITEMS_SORTED_OVERVIEW, 2);
    ...
    public void execute_multipleKeywords_multipleItemsFound() {
        String expectedMessage = String.format(MESSAGE_ITEMS_SORTED_OVERVIEW, 0);
