...
public class JsonAddressBookStorageTest {
    ...
    private java.util.Optional<ReadOnlyFoodRem> readAddressBook(String filePath) throws Exception {
     ...
     */
    private void saveAddressBook(ReadOnlyFoodRem addressBook, String filePath) {
        try {
    ...
    public void saveAddressBook_nullFilePath_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> saveAddressBook(new FoodRem(), null));
    }
}
