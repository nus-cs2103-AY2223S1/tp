...
public class ModelCommandTestUtil {
    ...
    public static final EditResidentDescriptor DESC_AMY;
    ...
    public static void assertCommandFailure(ModelCommand command, Model actualModel, String expectedMessage) {
        ...
        AddressBook expectedAddressBook = new AddressBook(actualModel.getResidentBook());
        List<Person> expectedFilteredList = new ArrayList<>(actualModel.getFilteredResidentList());

        assertThrows(CommandException.class, expectedMessage, () -> command.execute(actualModel));
        assertEquals(expectedAddressBook, actualModel.getResidentBook());
