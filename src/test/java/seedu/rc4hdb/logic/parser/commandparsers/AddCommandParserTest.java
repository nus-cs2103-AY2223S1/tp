...
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.EMAIL_DESC_BOB;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.GENDER_DESC_AMY;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.GENDER_DESC_BOB;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.HOUSE_DESC_AMY;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.HOUSE_DESC_BOB;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.INVALID_EMAIL_DESC;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.INVALID_GENDER_DESC;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.INVALID_HOUSE_DESC;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.INVALID_MATRIC_NUMBER_DESC;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.INVALID_NAME_DESC;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.INVALID_PHONE_DESC;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.INVALID_ROOM_DESC;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.INVALID_TAG_DESC;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.MATRIC_NUMBER_DESC_AMY;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.MATRIC_NUMBER_DESC_BOB;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.NAME_DESC_AMY;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.NAME_DESC_BOB;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.PHONE_DESC_AMY;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.PHONE_DESC_BOB;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.PREAMBLE_NON_EMPTY;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.PREAMBLE_WHITESPACE;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.ROOM_DESC_AMY;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.ROOM_DESC_BOB;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.TAG_DESC_FRIEND;
import static seedu.rc4hdb.logic.commands.ModelCommandTestUtil.TAG_DESC_HUSBAND;
