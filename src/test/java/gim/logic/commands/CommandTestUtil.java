...
public class CommandTestUtil {
    ...
    public static final String INVALID_REP_DESC = " " + PREFIX_REP; // empty string not allowed for addresses
    ...
    static {
        DESC_AMY = new EditExerciseDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withRep(VALID_REP_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditExerciseDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withRep(VALID_REP_BOB)
