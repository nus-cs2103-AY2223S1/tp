...
public class JsonAdaptedExerciseTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedExercise exercise =
                new JsonAdaptedExercise(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_REP, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedExercise exercise = new JsonAdaptedExercise(null, VALID_PHONE, VALID_EMAIL,
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedExercise exercise =
                new JsonAdaptedExercise(VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_REP, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedExercise exercise = new JsonAdaptedExercise(VALID_NAME, null,
                VALID_EMAIL, VALID_REP, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedExercise exercise =
                new JsonAdaptedExercise(VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_REP, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedExercise exercise = new JsonAdaptedExercise(VALID_NAME, VALID_PHONE, null,
                VALID_REP, VALID_TAGS);
    ...
    public void toModelType_invalidRep_throwsIllegalValueException() {
        JsonAdaptedExercise exercise =
                new JsonAdaptedExercise(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_REP, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedExercise exercise =
                new JsonAdaptedExercise(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_REP, invalidTags);
