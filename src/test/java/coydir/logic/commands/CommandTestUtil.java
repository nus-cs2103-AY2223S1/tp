...
public class CommandTestUtil {
    ...
    public static final String VALID_NAME_PRITTAM = "Prittam Kok";
    public static final String VALID_PHONE_AMY = "11111111";
    public static final String VALID_PHONE_BOB = "22222222";
    public static final String VALID_PHONE_PRITTAM = "00000000";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_EMAIL_PRITTAM = "null@null.com";
    ...
    public static final String NAME_DESC_PRITTAM = " " + PREFIX_NAME + VALID_NAME_PRITTAM;
    public static final String PHONE_DESC_AMY = " " + PREFIX_PHONE + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + PREFIX_PHONE + VALID_PHONE_BOB;
    public static final String PHONE_DESC_PRITTAM = " " + PREFIX_PHONE + VALID_PHONE_PRITTAM;
    public static final String EMAIL_DESC_AMY = " " + PREFIX_EMAIL + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_EMAIL + VALID_EMAIL_BOB;
    public static final String EMAIL_DESC_PRITTAM = " " + PREFIX_EMAIL + VALID_EMAIL_PRITTAM;
    ...
    public static final String INVALID_DEPARTMENT_DESC =
            " " + PREFIX_DEPARTMENT + "Invalid Department"; // not in list of valid departments
    ...
    /**
     * Convenience wrapper to {@link #assertCommandSuccess(Command, Model, CommandResult, Model)}
     * that takes a string {@code expectedMessage}, and an int {@code index} for viewing.
     */
    public static void assertViewingCommandSuccess(Command command, Model actualModel, String expectedMessage,
    ...
    /**
     * Convenience wrapper to {@link #assertCommandSuccess(Command, Model, CommandResult, Model)}
     * that takes a string {@code expectedMessage}, and an int {@code department} for viewing.
     */
    public static void assertViewDepartmentCommandSuccess(Command command, Model actualModel, String expectedMessage,
                                                   Model expectedModel, String department) {
        CommandResult expectedCommandResult = new CommandResult(expectedMessage, department);
        assertCommandSuccess(command, actualModel, expectedCommandResult, expectedModel);
    }
     ...
     * - the database, filtered person list and selected person in {@code actualModel} remain unchanged
     */
