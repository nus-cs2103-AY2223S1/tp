...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidEmployeeId_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, String.valueOf(TestUtil.getMaxEmployeeId()), VALID_PHONE, VALID_EMAIL,
                VALID_POSITION, VALID_DEPARTMENT, VALID_ADDRESS, "14", "14", VALID_TAGS,
                VALID_LEAVE, VALID_RATING, VALID_PERFORMANCEHISTORY);
        String expectedMessage = EmployeeId.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, TestUtil.getNextEmployeeId(), INVALID_PHONE, VALID_EMAIL,
                VALID_POSITION, VALID_DEPARTMENT, VALID_ADDRESS, VALID_LEAVE_NUMBER,
                VALID_LEAVE_NUMBER, VALID_TAGS, VALID_LEAVE, VALID_RATING, VALID_PERFORMANCEHISTORY);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, TestUtil.getNextEmployeeId(), null, VALID_EMAIL, VALID_POSITION,
                VALID_DEPARTMENT, VALID_ADDRESS, VALID_LEAVE_NUMBER, VALID_LEAVE_NUMBER, VALID_TAGS,
                VALID_LEAVE, VALID_RATING, VALID_PERFORMANCEHISTORY);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, TestUtil.getNextEmployeeId(), VALID_PHONE, INVALID_EMAIL, VALID_POSITION,
                VALID_DEPARTMENT, VALID_ADDRESS, VALID_LEAVE_NUMBER, VALID_LEAVE_NUMBER, VALID_TAGS,
                VALID_LEAVE, VALID_RATING, VALID_PERFORMANCEHISTORY);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, TestUtil.getNextEmployeeId(), VALID_PHONE, null, VALID_POSITION,
                VALID_DEPARTMENT, VALID_ADDRESS, VALID_LEAVE_NUMBER, VALID_LEAVE_NUMBER, VALID_TAGS,
                VALID_LEAVE, VALID_RATING, VALID_PERFORMANCEHISTORY);
    ...
    public void toModelType_invalidPosition_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, TestUtil.getNextEmployeeId(), VALID_PHONE, VALID_EMAIL, INVALID_POSITION,
                VALID_DEPARTMENT, VALID_ADDRESS, VALID_LEAVE_NUMBER, VALID_LEAVE_NUMBER, VALID_TAGS,
                VALID_LEAVE, VALID_RATING, VALID_PERFORMANCEHISTORY);
    ...
    public void toModelType_nullPosition_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, TestUtil.getNextEmployeeId(), VALID_PHONE, VALID_EMAIL, null, VALID_DEPARTMENT,
                VALID_ADDRESS, VALID_LEAVE_NUMBER, VALID_LEAVE_NUMBER, VALID_TAGS,
                VALID_LEAVE, VALID_RATING, VALID_PERFORMANCEHISTORY);
    ...
    public void toModelType_invalidDepartment_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, TestUtil.getNextEmployeeId(), VALID_PHONE, VALID_EMAIL, VALID_POSITION,
                INVALID_DEPARTMENT, VALID_ADDRESS, VALID_LEAVE_NUMBER, VALID_LEAVE_NUMBER, VALID_TAGS,
                VALID_LEAVE, VALID_RATING, VALID_PERFORMANCEHISTORY);
    ...
    public void toModelType_nullDepartment_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, TestUtil.getNextEmployeeId(), VALID_PHONE, VALID_EMAIL, VALID_POSITION, null,
                VALID_ADDRESS, VALID_LEAVE_NUMBER, VALID_LEAVE_NUMBER, VALID_TAGS,
                VALID_LEAVE, VALID_RATING, VALID_PERFORMANCEHISTORY);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, TestUtil.getNextEmployeeId(), VALID_PHONE, VALID_EMAIL, VALID_POSITION,
                VALID_DEPARTMENT, INVALID_ADDRESS, VALID_LEAVE_NUMBER, VALID_LEAVE_NUMBER, VALID_TAGS,
                VALID_LEAVE, VALID_RATING, VALID_PERFORMANCEHISTORY);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, TestUtil.getNextEmployeeId(), VALID_PHONE, VALID_EMAIL, VALID_POSITION,
                VALID_DEPARTMENT, null, VALID_LEAVE_NUMBER, VALID_LEAVE_NUMBER, VALID_TAGS,
                VALID_LEAVE, VALID_RATING, VALID_PERFORMANCEHISTORY);
