...
| `* * *`  | user                                        | add a new patient            | so that I can store the details of that patient                            |
| `* * *`  | user                                        | delete a patient             | remove entries that I no longer need                                       |
| `* * *`  | user                                        | find a patient by name       | locate details of the patient without having to go through the entire list |
