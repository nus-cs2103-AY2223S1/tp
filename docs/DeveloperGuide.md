...
| `* *`    | student                           | be able to delete an internship that I am not interested in anymore                                    | get rid of internship applications that are not relevant to me anymore                   |
| `*`      | student                           | be able to add an interview date to an application in the "INTERVIEW STAGE"                            | track when my interview is coming up.                                                    |
...
| `*`      | student                           | be able to rank all my internship applications                                                         | decide which applications that I have to focus on more.                                  |
...
| `*`      | easily confused student           | be able to prevent myself from adding the same internship application twice                            | I dont get distracted by duplicate internships                                           |
...
| `*`      | less experienced student with CLI | be able to view the list of commands                                                                   | familiarise myself with the commands.                                                    |
| `*`      | less experienced student          | be able to view some helpful resources                                                                 | understand the hiring process and tech landscapes better.                                |
| `*`      | anxious student                   | I want to able to switch to a calender view  |       easily see all my upcoming interviews/OAs/expiring offers                      |
| `*`      | anxious student                   | I want to able to switch to a calender view  |       easily see all my upcoming interviews/OAs/expiring offers                      |
