...
**`Main`** has two classes called [`Main`]({{ page.master_branch }}/src/main/java/seedu/foodrem/Main.java) and [`MainApp`]({{ page.master_branch }}/src/main/java/seedu/foodrem/MainApp.java). It is responsible for,
...
**API** : [`Logic.java`]({{ page.master_branch }}/src/main/java/seedu/foodrem/logic/Logic.java)
...
**API** : [`Model.java`]({{ page.master_branch }}/src/main/java/seedu/foodrem/model/Model.java)
...
**API** : [`Storage.java`]({{ page.master_branch }}/src/main/java/seedu/foodrem/storage/Storage.java)
