...
1. Viewing the Pie Chart for a list of entry
    ...
    2. Test case: `view t/e`<br>
       Expected: Expense tab displays all expenditure entries. Updated Pie Chart of expenditures is displayed. Success details shown in the status message.

    3. Test case: `view t/x`<br>
       Expected: Old Diagram remains shown. Error details shown in the status message.

    4. Other incorrect view commands to try: `view`, `view x`, `...` (where x is a string that does not follow the command format)<br>
       Expected: Similar to previous.
...
2. Viewing the Line Graph for a list of entry for a certain month
   ...
   2. Test case: `view t/e mo/2022-03`<br>
      Expected: Expense tab displays expenditure entries filtered by the specified month. Updated Line Graph of expenditures is displayed. Success details shown in the status message.
...
package to create Line Graph and Pie Chart in the application from scratch. In order to do so, we have faced multiple
