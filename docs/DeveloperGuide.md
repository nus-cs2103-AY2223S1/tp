...
**API** : [`Logic.java`](https://github.com/AY2223S1-CS2103T-T13-2/tp/tree/master/src/main/java/seedu/address/logic/Logic.java)
...
1. User requests to delete a certain tag or multiple tags.
