...
event command text entered by user. a represents the AddEventCommand instance and b represents the ModelManager instance
while event represents the instance of event class created and stored within AddEventCommand. 
...
`Model#deleteEvent()`. This operation subsequently calls upon the `AddressBook#deleteEvent()` operation which in turn call
...
event command text entered by user. a represents the DeleteEventCommand instance and b represents the ModelManager instance
while event represents the instance of event class created and stored within DeleteEventCommand. 
