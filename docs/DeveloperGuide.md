...
| `* *`  | user ready to start using the app | clear all current data                                                                   | get rid of sample/experimental data I used for exploring the app and quickly erase all applicant's data                                                                |
