...
**`Main`** has two classes called [`Main`]({{ page.master_branch }}/src/main/java/seedu/address/Main.java) and [`MainApp`]({{ page.master_branch }}/src/main/java/seedu/address/MainApp.java). It is responsible for,
...
**API** : [`Logic.java`]({{ page.master_branch }}/src/main/java/seedu/address/logic/Logic.java)
...
**API** : [`Model.java`]({{ page.master_branch }}/src/main/java/seedu/address/model/Model.java)
...
**API** : [`Storage.java`]({{ page.master_branch }}/src/main/java/seedu/address/storage/Storage.java)
