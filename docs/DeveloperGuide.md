...
An example of the new objects in the internal state when a valid `mark` command provided by the user, `mark 1 debt/2 3`, has been parsed is given by the object diagrams below.

<img src="images/MarkObjectDiagram.png" width="450" />
<img src="images/MarkObjectAfterDiagram.png" width="450" />
