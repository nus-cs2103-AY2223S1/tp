...
| `* * *`  | user                              | see the duration and students involved for my lessons           | can keep track of when and who I have to meet and I can make preparations       |
...
1. Initial launch
   ...
   1. Double-click the jar file Expected: Shows the GUI with a set of sample students, tasks and lists. The window size may not be optimum.
