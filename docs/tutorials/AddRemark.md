...
Create a new `Remark` in `gim.model.person`. Since a `Remark` is a field that is similar to `Address`, we can reuse a significant bit of code.
...
Then insert the following into [`main/resources/view/ExerciseListCard.fxml`](https://github.com/se-edu/addressbook-level3/commit/850b78879582f38accb05dd20c245963c65ea599#diff-d44c4f51c24f6253c277a2bb9bc440b8064d9c15ad7cb7ceda280bca032efce9).
...
AddressBook stores data by serializing `JsonAdaptedExercise` into `json` with the help of an external library — Jackson. Let’s update `JsonAdaptedExercise` to work with our new `Exercise`!
