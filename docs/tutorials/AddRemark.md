...
:exclamation: You must delete AddressBook’s storage file located at `/data/checkup.json` before running it! Not doing so will cause AddressBook to default to an empty address book!
