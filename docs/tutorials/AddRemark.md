...
``` java
public PersonCard(Person teammate, int displayedIndex) {
    //...
...
//...
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Person teammateToEdit = lastShownList.get(index.getZeroBased());
        Person editedTeammate = new Person(
     ...
     * {@code teammateToEdit}.
     */
    private String generateSuccessMessage(Person teammateToEdit) {
