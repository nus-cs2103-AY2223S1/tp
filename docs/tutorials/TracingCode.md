...
that belongs to the `Logic` component yields a promising candidate in `seedu.foodrem.logic.Logic`.
...
A quick look at the `seedu.foodrem.logic.Logic` (an extract given below) confirms that this indeed might be what we’re
looking for.
...
2. What components will you have to modify to perform the following enhancements to the application?
    ...
    3. Save FoodRem in the CSV format instead

    4. Add a new command

    5. Add a new field to `Person`

    6. Add a new entity to FoodRem
