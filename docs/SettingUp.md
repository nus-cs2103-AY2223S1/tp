...
Be sure to follow the steps in the following guide precisely. Things may not work out if you deviate in some steps.
</div>
...
1. **Verify the setup**:
    1. Run the `seedu.pennywise.Main` and try a few commands.
...
1. **Learn the design**
   ...
   about [Pennywise’s architecture](DeveloperGuide.md#architecture).
