...
|**Trip List Display** |where the Trips stored in Travelr are shown.<br><br> Commands to change the types of trips being shown:<html><ul><li>`completed`</li><li>`view`</li><li>`list`</li></ul></html>See feature list for more information about the commands.|
| **Event List Display** |where the Events stored in Travelr are shown.<br><br> Commands to change the types of events being shown:<html><ul><li>`completed`</li><li>`view`</li><li>`list-e`</li><li>`select`</li></ul></html>See feature list for more information about the commands.
