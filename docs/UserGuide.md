...
### Marking room clean status: `markRoomUnclean`

Marks room clean status of all guest as "no".

Format: `markRoomUnclean`
...
| **Edit**            | `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [dr/DATE_RANGE] [ng/NUMBER_OF_GUESTS] [rc/IS_ROOM_CLEAN]​`<br> e.g.,`edit 2 e/jameslee@example.com dr/13/09/22 - 15/09/22 ng/5`              |
| **Find**            | `find KEYWORD [MORE_KEYWORDS]`<br> e.g., `find James Jake`                                                                                                                            |
| **MarkRoomUnclean** | `markRoomUnclean`                                                                                                                                                                     |
| **List**            | `list`                                                                                                                                                                                |
| **Help**            | `help`                                                                                                                                                                                
