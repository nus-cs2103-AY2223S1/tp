...
1. [Introduction](#introduction)   
    1.1. [What is FinBook?](#what-is-finbook)
2. [How to use this User Guide?](#how-to-use-this-user-guide)   
    2.1. [Icons and symbols](#icons-and-symbols)   
    2.2. [User Interface (UI) of FinBook](#user-interface-ui-of-finbook)   
    2.3. [Command format](#command-format)
3. [Quick Start](#quick-start)
4. [Features](#features)   
    4.1. [Managing a client](#managing-a-client)      
   &emsp; 4.1.1. [Adding a client: `add`](#adding-a-client-add)   
   &emsp; 4.1.2. [Editing a client: `edit`](#editing-a-client--edit)   
   &emsp; 4.1.3. [Deleting a client: `delete`](#deleting-a-client--delete)   
   &emsp; 4.1.4. [Listing all clients: `list`](#listing-all-clients--list)   
   &emsp; 4.1.5. [Finding a client: `find`](#finding-a-client--find)   
   &emsp; 4.1.6. [Viewing Portfolio of a specific client: `view`](#viewing-portfolio-of-a-specific-client--view)   
   4.2. [Data privacy](#data-privacy)   
   &emsp; 4.2.1. [Locking the application: `lock`](#locking-the-application--lock)   
   &emsp; 4.2.2. [Setting or updating the password: `password`](#setting-or-updating-the-password--password)   
   4.3. [General](#general)   
   &emsp; 4.3.1. [Saving the data](#saving-the-data)   
   &emsp; 4.3.2. [Editing the data file](#editing-the-data-file)   
   &emsp; 4.3.3. [Importing data: `import`](#importing-data--import)   
   &emsp; 4.3.4. [Exporting data: `export`](#exporting-data--export)   
   &emsp; 4.3.5. [Copying a client's data: `copy`](#copying-a-clients-data--copy)   
   &emsp; 4.3.6. [Changing Light/Dark mode](#changing-lightdark-mode)   
   &emsp; 4.3.7. [Exiting the application: `exit`](#exiting-the-application--exit)   
5. [FAQ](#faq)   
6. [Glossary](#glossary)   
