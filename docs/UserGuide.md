...
| **Add interest**                 | `addInt INDEX INTEREST [MORE_INTERESTS]...` <br> Example: `addInt 2 baking tennis netflix`                                                                                                                   |
| **Delete interest**              | `deleteInt INDEX INTEREST [MORE_INTERESTS]...` <br> Example: `deleteInt 2 baking tennis`                                                                                                                     |
