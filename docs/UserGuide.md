...
4. Double-click the file to start the app. The GUI similar to the one below should appear. The below image is annotated with the various sections of the UI. 
