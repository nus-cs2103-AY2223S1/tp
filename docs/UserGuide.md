...
Examples:
* `edit 1 n/Johny p/91234567 e/johndoe@example.com` Edits the first member's personName in the global member list to Johny,
...
### Changing a team's personName: `editteam`
