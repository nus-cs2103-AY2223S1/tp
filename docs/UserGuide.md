...
4. [Features](#features)
   ...
   3. [Modifying contacts in CLInkedIn](#modifying-contacts-in-clinkedin)
      ...
      4. [Adding optional information `addNote`](#adding-optional-information-note)
      5. [Deleting optional information `deleteNote`](#deleting-optional-information-note)
      6. [Adding optional rating `addRate`](#adding-optional-rating-rate)
      7. [Sorting candidates based on rating `sort`](#sorting-candidates-based-on-rating-sort)
      8. [Adding optional links `addLink`](#adding-optional-link-rate)
      9. [Deleting links `DeleteLink`](#deleting-optional-link-rate)
   ...
   4. [Modifying contacts view in CLInkedIn](#modifying-contacts-view-in-clinkedin)
      1. [Viewing the details of a person `view`](#viewing-details-of-a-person)
      ...
      5. [Viewing statistics `stats`](#viewing-statistics-stat)
      6. [Importing contacts `import`](#importing-contacts-import)
      7. [Exporting contacts `export`](#exporting-contacts-export)
