...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| {::nomarkdown}<p align="center"><img src="images/find-module-before.png"/></p><p>Enter the command into the command box and hit <code>ENTER</code>.<br></p>{:/} | {::nomarkdown}<p align="center"><img src="images/find-module-after.png"/></p><p>The module list is now updated with modules whose module code starts with <code>CS</code>!</p>{:/} |
