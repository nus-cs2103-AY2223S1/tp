...
| [`add-person-to-module`](#216-add-person-to-module) | `add-person-to-module m/MODULE_CODE n/NAME`                             | Add person with specified name to a module with specified module code           |
