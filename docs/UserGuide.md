...
Sorts the contacts based on given list type and attributes in ascending order. This command is especially useful to 
check buyers with more orders, suppliers with more pets for sale, more urgent orders, and more expensive pets.
