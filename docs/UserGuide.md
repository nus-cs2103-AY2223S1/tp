...
| Parameter            | _Description_, Constraints                                                                                                                                                                                                                                                                                                                                             |
|----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **STAFF_NAME**       | _Name of Staff_ <br> - Only alphabetic characters and spaces are allowed. Special characters such as `.`, `'`, or `-` cannot be used. Numbers are not allowed as well. <br> - No character limit. <br> - Staff names must be unique. <br> - If you want to enter two Staff members of the same name, you can add a number behind to uniquely identify them e.g. John2. |
