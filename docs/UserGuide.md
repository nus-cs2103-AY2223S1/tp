...
* `edit A0234567H n/John Hoe p/Food Genetics` sets the name the student with student ID `A0123456G` into `John Hoe` and at the same time sets the project name into `Food Genetics`.
