...
| **Help**                    | `help`                                                                                                                                                                                                                                                                                                                                           |                                           |
| **List** specific tasks     | `ls [-a] [-u] [-m] [--module MODULE] [-t TAG] [-d YYYY-MM-DD]`<br/>`ls -a` View all tasks<br/>`ls -u` View all incomplete tasks<br/> `ls -m` View all marked tasks<br/> `ls --module <module>` View tasks under the specific module<br/> `ls -t <tag>` View tasks with a specific tag<br/> `ls -d <date>` View tasks on or after a specific date | `ls -u --module CS2103T`                  |
