...
4. Download the `modules.json` file from [here](https://github.com/AY2223S1-CS2103T-W10-4/tp/releases), and place it in the same
folder as `modtrekt.jar`. Do not rename, delete or move this file or its contents as doing so may result in the application not working as expected.
