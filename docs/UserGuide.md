...
|----------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Help**                                     | `help`                                                                                                                                                                                                                                                                                                                                |
| **Open customer/Switch to Customer Tab**     | `opencus [INDEX]`<br> e.g., <code>opencus <em>2</em></code>, <code>opencus</code>                                                                                                                                                                                                                                                     |
...
| **Open Commission/Switch to Commission Tab** | `opencom [INDEX]`<br> e.g., <code>opencom <em>14</em></code>, <code>opencom</code>                                                                                                                                                                                                                                                    |
